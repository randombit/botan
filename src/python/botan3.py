...
def _load_botan_dll(expected_version):
    ...
    if platform in ["win32", "cygwin", "msys"]:
        ...
        possible_dll_names += [
            "libbotan-3.so.%d" % (v) for v in reversed(range(min_minor, max_minor))
        ]
...
def _set_prototypes(dll):
    ...
    ffi_api(
        dll.botan_cipher_get_ideal_update_granularity, [c_void_p, POINTER(c_size_t)]
    )
    ffi_api(
        dll.botan_cipher_query_keylen, [c_void_p, POINTER(c_size_t), POINTER(c_size_t)]
    )
    ffi_api(
        dll.botan_cipher_get_keyspec,
        [c_void_p, POINTER(c_size_t), POINTER(c_size_t), POINTER(c_size_t)],
    )
    ...
    ffi_api(
        dll.botan_block_cipher_encrypt_blocks, [c_void_p, c_char_p, c_char_p, c_size_t]
    )
    ffi_api(
        dll.botan_block_cipher_decrypt_blocks, [c_void_p, c_char_p, c_char_p, c_size_t]
    )
    ffi_api(dll.botan_block_cipher_name, [c_void_p, c_char_p, POINTER(c_size_t)])
    ffi_api(
        dll.botan_block_cipher_get_keyspec,
        [c_void_p, POINTER(c_size_t), POINTER(c_size_t), POINTER(c_size_t)],
    )
    ...
    ffi_api(
        dll.botan_ec_group_from_params,
        [
            c_void_p,
            c_void_p,
            c_void_p,
    ...
    ffi_api(dll.botan_privkey_load, [c_void_p, c_void_p, c_char_p, c_size_t, c_char_p])
    ...
    ffi_api(
        dll.botan_privkey_export_encrypted,
        [c_void_p, c_char_p, POINTER(c_size_t), c_void_p, c_char_p, c_char_p, c_uint32],
    )

    ffi_api(
        dll.botan_privkey_export_encrypted_pbkdf_msec,
        [
            c_void_p,
            c_char_p,
            POINTER(c_size_t),
    ...
    ffi_api(
        dll.botan_privkey_export_encrypted_pbkdf_iter,
        [
            c_void_p,
            c_char_p,
            POINTER(c_size_t),
    ...
    ffi_api(
        dll.botan_privkey_view_encrypted_der,
        [
            c_void_p,
            c_void_p,
            c_char_p,
    ...
    ffi_api(
        dll.botan_privkey_view_encrypted_pem,
        [
            c_void_p,
            c_void_p,
            c_char_p,
    ...
    ffi_api(
        dll.botan_privkey_view_encrypted_der_timed,
        [
            c_void_p,
            c_void_p,
            c_char_p,
    ...
    ffi_api(
        dll.botan_privkey_view_encrypted_pem_timed,
        [
            c_void_p,
            c_void_p,
            c_char_p,
    ...
    ffi_api(
        dll.botan_pubkey_fingerprint, [c_void_p, c_char_p, c_char_p, POINTER(c_size_t)]
    )
    ...
    ffi_api(
        dll.botan_privkey_rsa_get_privkey,
        [c_void_p, c_char_p, POINTER(c_size_t), c_uint32],
    )
    ...
    ffi_api(
        dll.botan_privkey_load_dsa, [c_void_p, c_void_p, c_void_p, c_void_p, c_void_p]
    )
    ffi_api(
        dll.botan_pubkey_load_dsa, [c_void_p, c_void_p, c_void_p, c_void_p, c_void_p]
    )
    ...
    ffi_api(
        dll.botan_privkey_view_kyber_raw_key, [c_void_p, c_void_p, VIEW_BIN_CALLBACK]
    )
    ffi_api(
        dll.botan_pubkey_view_kyber_raw_key, [c_void_p, c_void_p, VIEW_BIN_CALLBACK]
    )
    ...
    ffi_api(
        dll.botan_privkey_load_classic_mceliece, [c_void_p, c_void_p, c_int, c_char_p]
    )
    ffi_api(
        dll.botan_pubkey_load_classic_mceliece, [c_void_p, c_void_p, c_int, c_char_p]
    )
    ...
    ffi_api(
        dll.botan_pubkey_sm2_compute_za,
        [c_char_p, POINTER(c_size_t), c_char_p, c_char_p, c_void_p],
    )
    ffi_api(
        dll.botan_pubkey_view_ec_public_point, [c_void_p, c_void_p, VIEW_BIN_CALLBACK]
    )
    ...
    ffi_api(
        dll.botan_pk_op_encrypt_output_length, [c_void_p, c_size_t, POINTER(c_size_t)]
    )
    ffi_api(
        dll.botan_pk_op_encrypt,
    ...
    ffi_api(
        dll.botan_pk_op_decrypt_output_length, [c_void_p, c_size_t, POINTER(c_size_t)]
    )
    ffi_api(
        dll.botan_pk_op_decrypt,
    ...
    ffi_api(
        dll.botan_pk_op_sign_finish, [c_void_p, c_void_p, c_char_p, POINTER(c_size_t)]
    )
    ...
    ffi_api(
        dll.botan_pk_op_kem_encrypt_shared_key_length,
        [c_void_p, c_size_t, POINTER(c_size_t)],
    )
    ffi_api(
        dll.botan_pk_op_kem_encrypt_encapsulated_key_length,
        [c_void_p, POINTER(c_size_t)],
    )

    ffi_api(
        dll.botan_pk_op_kem_encrypt_create_shared_key,
        [
            c_void_p,
            c_void_p,
            c_char_p,
    ...
    ffi_api(
        dll.botan_pk_op_kem_decrypt_shared_key_length,
        [c_void_p, c_size_t, POINTER(c_size_t)],
    )

    ffi_api(
        dll.botan_pk_op_kem_decrypt_shared_key,
        [
            c_void_p,
            c_char_p,
            c_size_t,
    ...
    ffi_api(
        dll.botan_x509_cert_get_time_starts, [c_void_p, c_char_p, POINTER(c_size_t)]
    )
    ffi_api(
        dll.botan_x509_cert_get_time_expires, [c_void_p, c_char_p, POINTER(c_size_t)]
    )
    ...
    ffi_api(
        dll.botan_x509_cert_get_fingerprint,
        [c_void_p, c_char_p, c_char_p, POINTER(c_size_t)],
    )
    ffi_api(
        dll.botan_x509_cert_get_serial_number, [c_void_p, c_char_p, POINTER(c_size_t)]
    )
    ffi_api(
        dll.botan_x509_cert_get_authority_key_id,
        [c_void_p, c_char_p, POINTER(c_size_t)],
    )
    ffi_api(
        dll.botan_x509_cert_get_subject_key_id, [c_void_p, c_char_p, POINTER(c_size_t)]
    )
    ffi_api(
        dll.botan_x509_cert_view_public_key_bits,
        [c_void_p, c_void_p, VIEW_BIN_CALLBACK],
    )
    ffi_api(dll.botan_x509_cert_get_public_key, [c_void_p, c_void_p])
    ffi_api(
        dll.botan_x509_cert_get_issuer_dn,
        [c_void_p, c_char_p, c_size_t, c_char_p, POINTER(c_size_t)],
    )
    ffi_api(
        dll.botan_x509_cert_get_subject_dn,
        [c_void_p, c_char_p, c_size_t, c_char_p, POINTER(c_size_t)],
    )
    ...
    ffi_api(
        dll.botan_x509_cert_verify_with_crl,
        [
            POINTER(c_int),
            c_void_p,
            c_void_p,
    ...
    ffi_api(
        dll.botan_srp6_server_session_step1,
        [
            c_void_p,
            c_char_p,
            c_size_t,
    ...
    ffi_api(
        dll.botan_srp6_server_session_step2,
        [c_void_p, c_char_p, c_size_t, c_char_p, POINTER(c_size_t)],
    )
    ffi_api(
        dll.botan_srp6_generate_verifier,
        [
            c_char_p,
            c_char_p,
            c_char_p,
...
def _ctype_bits(s: str | bytes) -> bytes:
    if isinstance(s, bytes):
        ...
        raise Exception(
            "Internal error - unexpected type %s provided to _ctype_bits"
            % (type(s).__name__)
        )
...
# Internal types
#
_MPIArg = Union[str, "MPI", Any, None]
...
class TPM2Context(TPM2Object):
    ...
    def __init__(
        self, tcti_name_maybe_with_conf: str | None = None, tcti_conf: str | None = None
    ):
        """Construct a TPM2Context object with optional TCTI name and configuration."""

        obj = c_void_p(0)
        if tcti_conf is not None:
            rc = _DLL.botan_tpm2_ctx_init_ex(
                byref(obj), _ctype_str(tcti_name_maybe_with_conf), _ctype_str(tcti_conf)
            )
        else:
            rc = _DLL.botan_tpm2_ctx_init(
                byref(obj), _ctype_str(tcti_name_maybe_with_conf)
            )
        if rc == -40:  # 'Not Implemented'
            raise BotanException(
                "TPM2 is not implemented in this build configuration", rc
            )
        self.rng_ = None
...
class TPM2Session(TPM2Object):
    ...
    def session_bundle_(*args):
        ...
        if len(args) <= 3 and all(isinstance(s, TPM2Session) for s in args):
            ...
            return (
                s.handle_() if isinstance(s, TPM2Session) else None for s in sessions
            )
        else:
            raise BotanException(
                "session bundle arguments must be 0 to 3 TPM2Session objects"
            )
        ...
        * 'tpm2':   Adapter to a TPM 2.0 RNG
        ...
        if rng_type == "tpm2":
            ...
            if not ctx or not isinstance(ctx, TPM2Context):
                raise BotanException(
                    "Cannot instantiate a TPM2-based RNG without a TPM2 context, pass tpm2_context= argument?"
                )
            sessions = TPM2Session.session_bundle_(kwargs.pop("tpm2_sessions", None))
            if kwargs:
                raise BotanException(
                    "Unexpected arguments for TPM2 RNG: %s" % (", ".join(kwargs.keys()))
                )
            _DLL.botan_tpm2_rng_init(byref(self.__obj), ctx.handle_(), *sessions)
        else:
            if kwargs:
                raise BotanException(
                    "Unexpected arguments for RNG type %s: %s"
                    % (rng_type, ", ".join(kwargs.keys()))
                )
...
class BlockCipher:
    def __init__(self, algo: str | c_void_p):
        ...
        _DLL.botan_block_cipher_get_keyspec(
            self.__obj, byref(min_keylen), byref(max_keylen), byref(mod_keylen)
        )
    ...
    def algo_name(self) -> str:
        return _call_fn_returning_str(
            32, lambda b, bl: _DLL.botan_block_cipher_name(self.__obj, b, bl)
        )
...
class HashFunction:
    def __init__(self, algo: str | c_void_p):
        ...
        self.__output_length = _call_fn_returning_sz(
            lambda length: _DLL.botan_hash_output_length(self.__obj, length)
        )
        self.__block_size = _call_fn_returning_sz(
            lambda length: _DLL.botan_hash_block_size(self.__obj, length)
        )
    ...
    def algo_name(self) -> str:
        return _call_fn_returning_str(
            32, lambda b, bl: _DLL.botan_hash_name(self.__obj, b, bl)
        )
...
class MsgAuthCode:
    ...
    def algo_name(self) -> str:
        return _call_fn_returning_str(
            32, lambda b, bl: _DLL.botan_mac_name(self.__obj, b, bl)
        )
...
class SymmetricCipher:
    ...
    def algo_name(self) -> str:
        return _call_fn_returning_str(
            32, lambda b, bl: _DLL.botan_cipher_name(self.__obj, b, bl)
        )
...
def bcrypt(passwd: str, rng_obj: RandomNumberGenerator, work_factor=10):
    ...
    flags = c_uint32(0)
    _DLL.botan_bcrypt_generate(
        out,
        byref(out_len),
        _ctype_str(passwd),
        rng_obj.handle_(),
        c_size_t(work_factor),
        flags,
    )
...
class PublicKey:  # pylint: disable=invalid-name
    ...
    @classmethod
    def load_rsa(cls, n: _MPIArg, e: _MPIArg) -> PublicKey:
        pub = PublicKey()
        n = MPI(n)
        e = MPI(e)
    ...
    @classmethod
    def load_dsa(cls, p: _MPIArg, q: _MPIArg, g: _MPIArg, y: _MPIArg) -> PublicKey:
        pub = PublicKey()
        p = MPI(p)
        q = MPI(q)
        g = MPI(g)
        y = MPI(y)
        _DLL.botan_pubkey_load_dsa(
            byref(pub.handle_()), p.handle_(), q.handle_(), g.handle_(), y.handle_()
        )
        return pub

    @classmethod
    def load_dh(cls, p: _MPIArg, g: _MPIArg, y: _MPIArg) -> PublicKey:
        pub = PublicKey()
        p = MPI(p)
        g = MPI(g)
        y = MPI(y)
        _DLL.botan_pubkey_load_dh(
            byref(pub.handle_()), p.handle_(), g.handle_(), y.handle_()
        )
        return pub

    @classmethod
    def load_elgamal(cls, p: _MPIArg, q: _MPIArg, g: _MPIArg, y: _MPIArg) -> PublicKey:
        pub = PublicKey()
        p = MPI(p)
        q = MPI(q)
        g = MPI(g)
        y = MPI(y)
        _DLL.botan_pubkey_load_elgamal(
            byref(pub.handle_()), p.handle_(), q.handle_(), g.handle_(), y.handle_()
        )
        return pub

    @classmethod
    def load_ecdsa(cls, curve: str, pub_x: _MPIArg, pub_y: _MPIArg) -> PublicKey:
        pub = PublicKey()
        pub_x = MPI(pub_x)
        pub_y = MPI(pub_y)
        _DLL.botan_pubkey_load_ecdsa(
            byref(pub.handle_()), pub_x.handle_(), pub_y.handle_(), _ctype_str(curve)
        )
        return pub
    ...
    def load_ecdsa_sec1(cls, curve: str, sec1_encoding: str | bytes) -> PublicKey:
        pub = PublicKey()
        _DLL.botan_pubkey_load_ecdsa_sec1(
            byref(pub.handle_()),
            _ctype_bits(sec1_encoding),
            len(sec1_encoding),
            _ctype_str(curve),
        )
        return pub
    ...
    @classmethod
    def load_ecdh(cls, curve: str, pub_x: _MPIArg, pub_y: _MPIArg) -> PublicKey:
        pub = PublicKey()
        pub_x = MPI(pub_x)
        pub_y = MPI(pub_y)
        _DLL.botan_pubkey_load_ecdh(
            byref(pub.handle_()), pub_x.handle_(), pub_y.handle_(), _ctype_str(curve)
        )
        return pub
    ...
    def load_ecdh_sec1(cls, curve: str, sec1_encoding: str | bytes) -> PublicKey:
        pub = PublicKey()
        _DLL.botan_pubkey_load_ecdh_sec1(
            byref(pub.handle_()),
            _ctype_bits(sec1_encoding),
            len(sec1_encoding),
            _ctype_str(curve),
    ...
    @classmethod
    def load_sm2(cls, curve: str, pub_x: _MPIArg, pub_y: _MPIArg) -> PublicKey:
        pub = PublicKey()
        pub_x = MPI(pub_x)
        pub_y = MPI(pub_y)
        _DLL.botan_pubkey_load_sm2(
            byref(pub.handle_()), pub_x.handle_(), pub_y.handle_(), _ctype_str(curve)
        )
        return pub
    ...
    def load_sm2_sec1(cls, curve: str, sec1_encoding: str | bytes) -> PublicKey:
        pub = PublicKey()
        _DLL.botan_pubkey_load_sm2_sec1(
            byref(pub.handle_()),
            _ctype_bits(sec1_encoding),
            len(sec1_encoding),
            _ctype_str(curve),
    ...
    def load_ml_kem(cls, mlkem_mode: str, key: bytes) -> PublicKey:
        pub = PublicKey()
        _DLL.botan_pubkey_load_ml_kem(
            byref(pub.handle_()), key, len(key), _ctype_str(mlkem_mode)
        )
        return pub
    ...
    def load_ml_dsa(cls, mldsa_mode: str, key: bytes) -> PublicKey:
        pub = PublicKey()
        _DLL.botan_pubkey_load_ml_dsa(
            byref(pub.handle_()), key, len(key), _ctype_str(mldsa_mode)
        )
        return pub
    ...
    def load_slh_dsa(cls, slhdsa_mode: str, key: bytes) -> PublicKey:
        pub = PublicKey()
        _DLL.botan_pubkey_load_slh_dsa(
            byref(pub.handle_()), key, len(key), _ctype_str(slhdsa_mode)
        )
        return pub
    ...
    def load_frodokem(cls, frodo_mode: str, key: bytes) -> PublicKey:
        pub = PublicKey()
        _DLL.botan_pubkey_load_frodokem(
            byref(pub.handle_()), key, len(key), _ctype_str(frodo_mode)
        )
        return pub
    ...
    def load_classic_mceliece(cls, cmce_mode: str, key: bytes) -> PublicKey:
        pub = PublicKey()
        _DLL.botan_pubkey_load_classic_mceliece(
            byref(pub.handle_()), key, len(key), _ctype_str(cmce_mode)
        )
        return pub
    ...
    def algo_name(self) -> str:
        return _call_fn_returning_str(
            32, lambda b, bl: _DLL.botan_pubkey_algo_name(self.__obj, b, bl)
        )
    ...
    def to_der(self) -> bytes:
        return _call_fn_viewing_vec(
            lambda vc, vfn: _DLL.botan_pubkey_view_der(self.__obj, vc, vfn)
        )

    def to_pem(self) -> str:
        return _call_fn_viewing_str(
            lambda vc, vfn: _DLL.botan_pubkey_view_pem(self.__obj, vc, vfn)
        )

    def to_raw(self) -> bytes:
        return _call_fn_viewing_vec(
            lambda vc, vfn: _DLL.botan_pubkey_view_raw(self.__obj, vc, vfn)
        )

    def view_kyber_raw_key(self) -> bytes:
        """Deprecated: use to_raw() instead"""
        return _call_fn_viewing_vec(
            lambda vc, vfn: _DLL.botan_pubkey_view_kyber_raw_key(self.__obj, vc, vfn)
        )
    ...
    def fingerprint(self, hash_algorithm: str = "SHA-256") -> str:
        ...
        _DLL.botan_pubkey_fingerprint(
            self.__obj, _ctype_str(hash_algorithm), buf, byref(buf_len)
        )
    ...
    def get_public_point(self) -> bytes:
        return _call_fn_viewing_vec(
            lambda vc, vfn: _DLL.botan_pubkey_view_ec_public_point(self.__obj, vc, vfn)
        )
...
class PrivateKey:
    ...
    def load(cls, val: str | bytes, passphrase: str = "") -> PrivateKey:
        ...
        bits = _ctype_bits(val)
        _DLL.botan_privkey_load(
            byref(priv.handle_()), rng_obj, bits, len(bits), _ctype_str(passphrase)
        )
        return priv
    ...
    def create(
        cls,
        algo: str,
        params: str | int | tuple[int, int],
        rng_obj: RandomNumberGenerator,
    ) -> PrivateKey:
        if algo == "rsa":
            algo = "RSA"
            params = "%d" % (params)
    ...
    @classmethod
    def create_ec(
        cls, algo: str, ec_group: ECGroup, rng_obj: RandomNumberGenerator
    ) -> PrivateKey:
        obj = c_void_p(0)
        _DLL.botan_ec_privkey_create(
            byref(obj), _ctype_str(algo), ec_group.handle_(), rng_obj.handle_()
        )
        return PrivateKey(obj)

    @classmethod
    def load_rsa(cls, p: _MPIArg, q: _MPIArg, e: _MPIArg) -> PrivateKey:
        priv = PrivateKey()
        p = MPI(p)
        q = MPI(q)
        e = MPI(e)
        _DLL.botan_privkey_load_rsa(
            byref(priv.handle_()), p.handle_(), q.handle_(), e.handle_()
        )
        return priv

    @classmethod
    def load_dsa(cls, p: _MPIArg, q: _MPIArg, g: _MPIArg, x: _MPIArg) -> PrivateKey:
        priv = PrivateKey()
        p = MPI(p)
        q = MPI(q)
        g = MPI(g)
        x = MPI(x)
        _DLL.botan_privkey_load_dsa(
            byref(priv.handle_()), p.handle_(), q.handle_(), g.handle_(), x.handle_()
        )
        return priv

    @classmethod
    def load_dh(cls, p: _MPIArg, g: _MPIArg, x: _MPIArg) -> PrivateKey:
        priv = PrivateKey()
        p = MPI(p)
        g = MPI(g)
        x = MPI(x)
        _DLL.botan_privkey_load_dh(
            byref(priv.handle_()), p.handle_(), g.handle_(), x.handle_()
        )
        return priv

    @classmethod
    def load_elgamal(cls, p: _MPIArg, q: _MPIArg, g: _MPIArg, x: _MPIArg) -> PrivateKey:
        priv = PrivateKey()
        p = MPI(p)
        q = MPI(q)
        g = MPI(g)
        x = MPI(x)
        _DLL.botan_privkey_load_elgamal(
            byref(priv.handle_()), p.handle_(), q.handle_(), g.handle_(), x.handle_()
        )
        return priv

    @classmethod
    def load_ecdsa(cls, curve: str, x: _MPIArg) -> PrivateKey:
        priv = PrivateKey()
        x = MPI(x)
        _DLL.botan_privkey_load_ecdsa(
            byref(priv.handle_()), x.handle_(), _ctype_str(curve)
        )
        return priv

    @classmethod
    def load_ecdh(cls, curve: str, x: _MPIArg) -> PrivateKey:
        priv = PrivateKey()
        x = MPI(x)
        _DLL.botan_privkey_load_ecdh(
            byref(priv.handle_()), x.handle_(), _ctype_str(curve)
        )
        return priv

    @classmethod
    def load_sm2(cls, curve: str, x: _MPIArg) -> PrivateKey:
        priv = PrivateKey()
        x = MPI(x)
        _DLL.botan_privkey_load_sm2(
            byref(priv.handle_()), x.handle_(), _ctype_str(curve)
        )
        return priv
    ...
    def load_ml_kem(cls, mlkem_mode: str, key: bytes) -> PrivateKey:
        priv = PrivateKey()
        _DLL.botan_privkey_load_ml_kem(
            byref(priv.handle_()), key, len(key), _ctype_str(mlkem_mode)
        )
        return priv
    ...
    def load_ml_dsa(cls, mldsa_mode, key):
        priv = PrivateKey()
        _DLL.botan_privkey_load_ml_dsa(
            byref(priv.handle_()), key, len(key), _ctype_str(mldsa_mode)
        )
        return priv
    ...
    def load_slh_dsa(cls, slh_dsa: str, key: bytes) -> PrivateKey:
        priv = PrivateKey()
        _DLL.botan_privkey_load_slh_dsa(
            byref(priv.handle_()), key, len(key), _ctype_str(slh_dsa)
        )
        return priv
    ...
    def load_frodokem(cls, frodo_mode: str, key: bytes) -> PrivateKey:
        priv = PrivateKey()
        _DLL.botan_privkey_load_frodokem(
            byref(priv.handle_()), key, len(key), _ctype_str(frodo_mode)
        )
        return priv
    ...
    def load_classic_mceliece(cls, cmce_mode: str, key: bytes) -> PrivateKey:
        priv = PrivateKey()
        _DLL.botan_privkey_load_classic_mceliece(
            byref(priv.handle_()), key, len(key), _ctype_str(cmce_mode)
        )
        return priv
    ...
    def algo_name(self) -> str:
        return _call_fn_returning_str(
            32, lambda b, bl: _DLL.botan_privkey_algo_name(self.__obj, b, bl)
        )
    ...
    def to_der(self) -> bytes:
        return _call_fn_viewing_vec(
            lambda vc, vfn: _DLL.botan_privkey_view_der(self.__obj, vc, vfn)
        )

    def to_pem(self) -> str:
        return _call_fn_viewing_str(
            lambda vc, vfn: _DLL.botan_privkey_view_pem(self.__obj, vc, vfn)
        )

    def to_raw(self) -> bytes:
        return _call_fn_viewing_vec(
            lambda vc, vfn: _DLL.botan_privkey_view_raw(self.__obj, vc, vfn)
        )

    def view_kyber_raw_key(self) -> bytes:
        """Deprecated: use to_raw() instead"""
        return _call_fn_viewing_vec(
            lambda vc, vfn: _DLL.botan_privkey_view_kyber_raw_key(self.__obj, vc, vfn)
        )
...
class PKEncrypt:
    def __init__(self, key: PublicKey, padding: str):
        ...
        _DLL.botan_pk_op_encrypt_create(
            byref(self.__obj), key.handle_(), _ctype_str(padding), flags
        )
    ...
    def encrypt(self, msg: bytes, rng_obj: RandomNumberGenerator) -> bytes:
        ...
        _DLL.botan_pk_op_encrypt(
            self.__obj, rng_obj.handle_(), outbuf, byref(outbuf_sz), msg, len(msg)
        )
...
class PKDecrypt:
    def __init__(self, key: PrivateKey, padding: str):
        self.__obj = c_void_p(0)
        flags = c_uint32(0)  # always zero in this ABI
        _DLL.botan_pk_op_decrypt_create(
            byref(self.__obj), key.handle_(), _ctype_str(padding), flags
        )
...
class PKSign:  # pylint: disable=invalid-name
    ...
    def finish(self, rng_obj: RandomNumberGenerator) -> bytes:
        ...
        outbuf = create_string_buffer(outbuf_sz.value)
        _DLL.botan_pk_op_sign_finish(
            self.__obj, rng_obj.handle_(), outbuf, byref(outbuf_sz)
        )
        return outbuf.raw[0 : int(outbuf_sz.value)]
...
class PKVerify:
    def __init__(self, key: PublicKey, padding: str, der: bool = False):
        self.__obj = c_void_p(0)
        flags = c_uint32(1) if der else c_uint32(0)
        _DLL.botan_pk_op_verify_create(
            byref(self.__obj), key.handle_(), _ctype_str(padding), flags
        )
...
class PKKeyAgreement:
    def __init__(self, key: PrivateKey, kdf_name: str):
        self.__obj = c_void_p(0)
        flags = c_uint32(0)  # always zero in this ABI
        _DLL.botan_pk_op_key_agreement_create(
            byref(self.__obj), key.handle_(), _ctype_str(kdf_name), flags
        )

        self.m_public_value = _call_fn_viewing_vec(
            lambda vc, vfn: _DLL.botan_pk_op_key_agreement_view_public(
                key.handle_(), vc, vfn
            )
        )
    ...
    def agree(self, other: bytes, key_len: int, salt: bytes) -> bytes:
        ...
        return _call_fn_returning_vec(
            key_len,
            lambda b, bl: _DLL.botan_pk_op_key_agreement(
                self.__obj, b, bl, other, len(other), salt, len(salt)
            ),
        )
...
class KemEncrypt:
    def __init__(self, key: PublicKey, params: str):
        self.__obj = c_void_p(0)
        _DLL.botan_pk_op_kem_encrypt_create(
            byref(self.__obj), key.handle_(), _ctype_str(params)
        )
    ...
    def shared_key_length(self, desired_key_len: int) -> int:
        return _call_fn_returning_sz(
            lambda len: _DLL.botan_pk_op_kem_encrypt_shared_key_length(
                self.__obj, desired_key_len, len
            )
        )
    ...
    def create_shared_key(
        self, rng: RandomNumberGenerator, salt: bytes, desired_key_len: int
    ) -> tuple[bytes, bytes]:
...
class KemDecrypt:
    def __init__(self, key: PrivateKey, params: str):
        self.__obj = c_void_p(0)
        _DLL.botan_pk_op_kem_decrypt_create(
            byref(self.__obj), key.handle_(), _ctype_str(params)
        )
    ...
    def shared_key_length(self, desired_key_len: int) -> int:
        return _call_fn_returning_sz(
            lambda len: _DLL.botan_pk_op_kem_decrypt_shared_key_length(
                self.__obj, desired_key_len, len
            )
        )

    def decrypt_shared_key(
        self, salt: bytes, desired_key_len: int, encapsulated_key: bytes
    ) -> bytes:
        shared_key_len = self.shared_key_length(desired_key_len)
...
class X509Cert:  # pylint: disable=invalid-name
    def __init__(self, filename: str | None = None, buf: bytes | None = None):
        self.__obj = c_void_p(0)
        self.__obj = _load_buf_or_file(
            filename, buf, _DLL.botan_x509_cert_load_file, _DLL.botan_x509_cert_load
        )
    ...
    def fingerprint(self, hash_algo: str = "SHA-256") -> str:
        ...
        return _call_fn_returning_str(
            n,
            lambda b, bl: _DLL.botan_x509_cert_get_fingerprint(
                self.__obj, _ctype_str(hash_algo), b, bl
            ),
        )
    ...
    def authority_key_id(self) -> bytes:
        return _call_fn_returning_vec(
            32,
            lambda b, bl: _DLL.botan_x509_cert_get_authority_key_id(self.__obj, b, bl),
        )
    ...
    def subject_public_key_bits(self) -> bytes:
        return _call_fn_viewing_vec(
            lambda vc, vfn: _DLL.botan_x509_cert_view_public_key_bits(
                self.__obj, vc, vfn
            )
        )
    ...
    def subject_dn(self, key: str, index: int) -> str:
        return _call_fn_returning_str(
            0,
            lambda b, bl: _DLL.botan_x509_cert_get_subject_dn(
                self.__obj, _ctype_str(key), index, b, bl
            ),
        )
    ...
    def issuer_dn(self, key: str, index: int) -> str:
        return _call_fn_returning_str(
            0,
            lambda b, bl: _DLL.botan_x509_cert_get_issuer_dn(
                self.__obj, _ctype_str(key), index, b, bl
            ),
        )
    ...
    def verify(
        ...
        _DLL.botan_x509_cert_verify_with_crl(
            byref(error_code),
            self.__obj,
...
class X509CRL:
    def __init__(self, filename: str | None = None, buf: bytes | None = None):
        self.__obj = c_void_p(0)
        self.__obj = _load_buf_or_file(
            filename, buf, _DLL.botan_x509_crl_load_file, _DLL.botan_x509_crl_load
        )
...
class MPI:
    def __init__(self, initial_value: _MPIArg = None, radix: int | None = None):
        ...
        if initial_value is None:
            ...
            _DLL.botan_mp_set_from_radix_str(
                self.__obj, _ctype_str(initial_value), c_size_t(radix)
            )
    ...
    def random_range(cls, rng_obj: RandomNumberGenerator, lower: MPI, upper: MPI):
        bn = MPI()
        _DLL.botan_mp_rand_range(
            bn.handle_(), rng_obj.handle_(), lower.handle_(), upper.handle_()
        )
        return bn
    ...
    def mod_mul(self, other: MPI, modulus: MPI) -> MPI:
        r = MPI()
        _DLL.botan_mp_mod_mul(
            r.handle_(), self.__obj, other.handle_(), modulus.handle_()
        )
        return r
    ...
    def pow_mod(self, exponent: MPI, modulus: MPI) -> MPI:
        r = MPI()
        _DLL.botan_mp_powmod(
            r.handle_(), self.__obj, exponent.handle_(), modulus.handle_()
        )
        return r

    def is_prime(self, rng_obj: RandomNumberGenerator, prob: int = 128) -> bool:
        return (
            _DLL.botan_mp_is_prime(self.__obj, rng_obj.handle_(), c_size_t(prob)) == 1
        )
...
class ECGroup:
    ...
    @classmethod
    def from_params(
        cls, oid: OID, p: MPI, a: MPI, b: MPI, base_x: MPI, base_y: MPI, order: MPI
    ) -> ECGroup:
        ec_group = ECGroup()
    ...
    def to_der(self) -> bytes:
        return _call_fn_viewing_vec(
            lambda vc, vfn: _DLL.botan_ec_group_view_der(self.__obj, vc, vfn)
        )

    def to_pem(self) -> str:
        return _call_fn_viewing_str(
            lambda vc, vfn: _DLL.botan_ec_group_view_pem(self.__obj, vc, vfn)
        )
...
class FormatPreservingEncryptionFE1:
    def __init__(
        self, modulus: MPI, key: bytes, rounds: int = 5, compat_mode: bool = False
    ):
        flags = c_uint32(1 if compat_mode else 0)
        self.__obj = c_void_p(0)
        _DLL.botan_fpe_fe1_init(
            byref(self.__obj), modulus.handle_(), key, len(key), c_size_t(rounds), flags
        )

    def __del__(self):
        _DLL.botan_fpe_destroy(self.__obj)

    def encrypt(self, msg: _MPIArg, tweak: str | bytes) -> MPI:
        r = MPI(msg)
        bits = _ctype_bits(tweak)
        _DLL.botan_fpe_encrypt(self.__obj, r.handle_(), bits, len(bits))
        return r

    def decrypt(self, msg: _MPIArg, tweak: str | bytes) -> MPI:
        r = MPI(msg)
        bits = _ctype_bits(tweak)
...
class HOTP:
    def __init__(self, key: bytes, digest: str = "SHA-1", digits: int = 6):
        self.__obj = c_void_p(0)
        _DLL.botan_hotp_init(
            byref(self.__obj), key, len(key), _ctype_str(digest), digits
        )
    ...
    def check(self, code: int, counter: int, resync_range: int = 0) -> tuple[bool, int]:
        next_ctr = c_uint64(0)
        rc = _DLL.botan_hotp_check(
            self.__obj, byref(next_ctr), code, counter, resync_range
        )
        if rc == 0:
...
class TOTP:
    def __init__(
        self, key: bytes, digest: str = "SHA-1", digits: int = 6, timestep: int = 30
    ):
        self.__obj = c_void_p(0)
        _DLL.botan_totp_init(
            byref(self.__obj), key, len(key), _ctype_str(digest), digits, timestep
        )
    ...
    def check(
        self, code: int, timestamp: int | None = None, acceptable_drift: int = 0
    ) -> bool:
        if timestamp is None:
            timestamp = int(system_time())
...
def nist_key_wrap(kek: bytes, key: bytes, cipher: str | None = None) -> bytes:
    ...
    _DLL.botan_nist_kw_enc(
        _ctype_str(cipher_algo),
        padding,
        key,
        len(key),
        kek,
...
class Srp6ServerSession:
    ...
    def step1(self, verifier: bytes, hsh: str, rng: RandomNumberGenerator) -> bytes:
        return _call_fn_returning_vec(
            self.__group_size,
            lambda b, bl: _DLL.botan_srp6_server_session_step1(
                self.__obj,
                verifier,
                len(verifier),
    ...
    def step2(self, a: bytes):
        return _call_fn_returning_vec(
            self.__group_size,
            lambda k, kl: _DLL.botan_srp6_server_session_step2(
                self.__obj, a, len(a), k, kl
            ),
        )


def srp6_generate_verifier(
    identifier: str, password: str, salt: bytes, group: str, hsh: str
) -> bytes:
    sz = _call_fn_returning_sz(
        lambda len: _DLL.botan_srp6_group_size(_ctype_str(group), len)
    )

    return _call_fn_returning_vec(
        sz,
        lambda v, vl: _DLL.botan_srp6_generate_verifier(
            _ctype_str(identifier),
            _ctype_str(password),
            salt,
            len(salt),
            _ctype_str(group),
...
def srp6_client_agree(
    ...
    return _call_fn_returning_vec_pair(
        sz,
        sz,
        lambda a, al, k, kl: _DLL.botan_srp6_client_agree(
            _ctype_str(username),
            _ctype_str(password),
            _ctype_str(group),
            _ctype_str(hsh),
...
def zfec_encode(k: int, n: int, input_bytes: bytes) -> List[bytes]:
    ...
    outputs = [create_string_buffer(outsize) for a in range(n)]

    c_outputs = p_p_nbytes(*[addressof(output) for output in outputs])
...
def zfec_decode(k: int, n: int, indexes: List[int], inputs: List[bytes]) -> List[bytes]:
    ...
    for i in inputs:
        if len(i) != share_size:
            raise ValueError("Share size mismatch: {} != {}".format(len(i), share_size))

    # allocate memory for our outputs (create_string_buffer creates
    # bytes)
    outputs = [create_string_buffer(share_size) for _ in range(k)]
    p_p_kbytes = c_char_p * k
    c_outputs = p_p_kbytes(*[addressof(output) for output in outputs])
