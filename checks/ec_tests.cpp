...
BOOST_AUTO_TEST_CASE(test_point_turn_on_sp_red_mul_simple)
{
	cout << "." << flush;
    // init the lib
    ...
    Botan::EC_Domain_Params dom_pars(Botan::get_EC_Dom_Pars_by_oid("1.3.36.3.3.2.8.1.1.5"));
    PointGFp p(dom_pars.get_base_point());
    p.turn_on_sp_red_mul();
    BOOST_CHECK(p.get_affine_x().get_value() != BigInt(0));
}

BOOST_AUTO_TEST_CASE(test_point_turn_on_sp_red_mul)
{
	cout << "." << flush;
    // init the lib
    Botan::InitializerOptions init_options("");
    ...
    Botan::SecureVector<Botan::byte> sv_p_secp = decode_hex(p_secp);
...
BOOST_AUTO_TEST_CASE( test_coordinates)
{
	cout << "." << flush;
    // init the lib
    Botan::InitializerOptions init_options("");
...
BOOST_AUTO_TEST_CASE( test_point_transformation )
{
	cout << "." << flush;
    // init the lib
    Botan::InitializerOptions init_options("");
...
BOOST_AUTO_TEST_CASE( test_point_mult )
{
	cout << "." << flush;
    // init the lib
    Botan::InitializerOptions init_options("");
    ...
    Botan::SecureVector<Botan::byte> sv_G_dec = EC2OSP(p_G,0x01);
    string str_d_U = "aa374ffc3ce144e6b073307972cb6d57b2a4e982";
    Botan::SecureVector<Botan::byte> sv_d_U = decode_hex(str_d_U);
...
/*BOOST_AUTO_TEST_CASE( test_montgm_calc_R )
{
...
BOOST_AUTO_TEST_CASE( test_naive_montg_mult )
{
	cout << "." << flush;
    // init the lib
    Botan::InitializerOptions init_options("");
...
/*BOOST_AUTO_TEST_CASE( test_trf_mres )
{
// this tests isnt´t correct anymore. the determination of R has changed
// to be 0 mod word_range.
// init the lib
...
BOOST_AUTO_TEST_CASE( test_zeropoint)
{
	cout << "." << flush;
    // init the lib
    Botan::InitializerOptions init_options("");
...
BOOST_AUTO_TEST_CASE( test_zeropoint_enc_dec)
{
	cout << "." << flush;
    // init the lib
    Botan::InitializerOptions init_options("");
    ...
    Botan::SecureVector<Botan::byte> sv_p = EC2OSP(p, PointGFp::UNCOMPRESSED);
...
BOOST_AUTO_TEST_CASE( test_calc_with_zeropoint)
{
	cout << "." << flush;
    // init the lib
    Botan::InitializerOptions init_options("");
...
BOOST_AUTO_TEST_CASE( test_sub_point)
{
	cout << "." << flush;
    // init the lib
    Botan::InitializerOptions init_options("");
...
BOOST_AUTO_TEST_CASE( test_mult_point)
{
	cout << "." << flush;
    // init the lib
    Botan::InitializerOptions init_options("");
...
BOOST_AUTO_TEST_CASE( test_enc_dec_compressed_160)
{
	cout << "." << flush;
    // init the lib
    Botan::InitializerOptions init_options("");
    ...
    PointGFp p_G = OS2ECP ( sv_G_secp_comp, secp160r1 );
    Botan::SecureVector<Botan::byte> sv_result = EC2OSP(p_G, PointGFp::COMPRESSED);

    BOOST_CHECK( sv_result == sv_G_secp_comp);
}

BOOST_AUTO_TEST_CASE( test_enc_dec_compressed_256)
{
	cout << "." << flush;
    // init the lib
    Botan::InitializerOptions init_options("");
...
BOOST_AUTO_TEST_CASE( test_enc_dec_uncompressed_112)
{
	cout << "." << flush;
    // init the lib
    Botan::InitializerOptions init_options("");
    ...
    Botan::SecureVector<Botan::byte> sv_a_secp = decode_hex ( a_secp );
    Botan::SecureVector<Botan::byte> sv_b_secp = decode_hex ( b_secp );
    Botan::SecureVector<Botan::byte> sv_G_secp_uncomp = decode_hex ( G_secp_uncomp );
    ...
    Botan::SecureVector<Botan::byte> sv_result = EC2OSP(p_G, PointGFp::UNCOMPRESSED);

    BOOST_CHECK( sv_result == sv_G_secp_uncomp);
}

BOOST_AUTO_TEST_CASE( test_enc_dec_uncompressed_521)
{
	cout << "." << flush;
    // init the lib
    Botan::InitializerOptions init_options("");
...
BOOST_AUTO_TEST_CASE( test_enc_dec_uncompressed_521_prime_too_large)
{
	cout << "." << flush;
    // init the lib
    Botan::InitializerOptions init_options("");
...
BOOST_AUTO_TEST_CASE( test_gfp_store_restore)
{
	cout << "." << flush;
//    cout << "starting gfp_store_restore..." << endl;
    ...
    //Botan::EC_Domain_Params dom_pars("1.3.132.0.8");
    Botan::EC_Domain_Params dom_pars(Botan::get_EC_Dom_Pars_by_oid("1.3.132.0.8"));
    PointGFp p = dom_pars.get_base_point();

    //store point (to string)
    Botan::SecureVector<Botan::byte> sv_mes = EC2OSP(p, PointGFp::COMPRESSED);
    string storrage = hex_encode(sv_mes, sv_mes.size());

    // restore point (from string)
    Botan::SecureVector<Botan::byte> sv_new_point = decode_hex(storrage);
...
BOOST_AUTO_TEST_CASE( test_cdc_curve_33)
{
	cout << "." << flush;
    Botan::InitializerOptions init_options("");
    Botan::LibraryInitializer init(init_options);
    ...
    Botan::SecureVector<Botan::byte> sv_G_uncomp = decode_hex ( G_secp_uncomp );
...
BOOST_AUTO_TEST_CASE( test_more_zeropoint)
{
    ...
    Botan::SecureVector<Botan::byte> sv_G_secp_comp = decode_hex ( G );
...
BOOST_AUTO_TEST_CASE(test_gfp_curve_precomp_mres)
{
	cout << "." << flush;
    Botan::InitializerOptions init_options("");
    Botan::LibraryInitializer init(init_options);

    //Botan::EC_Domain_Params parA("1.2.840.10045.3.1.1");
...
/*BOOST_AUTO_TEST_CASE(test_point_worksp)
{
Botan::InitializerOptions init_options("");
Botan::LibraryInitializer init(init_options);
Botan::EC_Domain_Params dom_pars(Botan::get_EC_Dom_Pars_by_oid("1.3.132.0.8"));
...
BOOST_AUTO_TEST_CASE(test_point_swap)
{
	cout << "." << flush;
    Botan::InitializerOptions init_options("");
    Botan::LibraryInitializer init(init_options);
...
*/
BOOST_AUTO_TEST_CASE(test_mult_sec)
{
	cout << "." << flush;
    Botan::InitializerOptions init_options("");
    Botan::LibraryInitializer init(init_options);
...
* yields the same result as the normal (insecure) multiplication via operator*=
*/
BOOST_AUTO_TEST_CASE(test_mult_sec_mass)
{
    Botan::InitializerOptions init_options("");
    Botan::LibraryInitializer init(init_options);
    Botan::EC_Domain_Params dom_pars(Botan::get_EC_Dom_Pars_by_oid("1.3.132.0.8"));
    for(int i = 0; i<50; i++)
    {
        ...
        cout.flush();
        PointGFp a(create_random_point(dom_pars.get_curve()));
        BigInt scal(Botan::random_integer(40));
        PointGFp b = a * scal;
        PointGFp c(a);
...
*/
BOOST_AUTO_TEST_CASE(test_point_ctors_ass_unshared)
{
	cout << "." << flush;
    Botan::InitializerOptions init_options("");
    Botan::LibraryInitializer init(init_options);
...
BOOST_AUTO_TEST_CASE(test_curve_cp_ctor)
{
	cout << "." << flush;
    Botan::InitializerOptions init_options("");
    Botan::LibraryInitializer init(init_options);
...
*/
BOOST_AUTO_TEST_CASE(test_ec_key_cp_and_assignment)
{
	cout << "." << flush;
    Botan::InitializerOptions init_options("");
    Botan::LibraryInitializer init(init_options);
    ...
    Botan::ECDSA_PrivateKey cp_key(my_priv_key);
    Botan::SecureVector<Botan::byte> cp_sig = cp_key.sign(sv_message.begin(), sv_message.size());
    ...
    Botan::ECDSA_PrivateKey ass_key = my_priv_key;
    Botan::SecureVector<Botan::byte> ass_sig = ass_key.sign(sv_message.begin(), sv_message.size());
...
BOOST_AUTO_TEST_CASE(test_ec_key_cast)
{
	cout << "." << flush;
    Botan::InitializerOptions init_options("");
    Botan::LibraryInitializer init(init_options);
    ...
    Botan::EC_Domain_Params dom_pars = Botan::EC_Domain_Params(curve, p_G, order, cofactor);
    Botan::ECDSA_PrivateKey my_priv_key(dom_pars);
    Botan::ECDSA_PublicKey my_ecdsa_pub_key = my_priv_key;

    Botan::Public_Key* my_pubkey = static_cast<Botan::Public_Key*>(&my_ecdsa_pub_key);
    Botan::ECDSA_PublicKey* ec_cast_back = dynamic_cast<Botan::ECDSA_PublicKey*>(my_pubkey);
