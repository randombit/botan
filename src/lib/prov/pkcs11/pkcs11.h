 ...
 * Source:
 * https://github.com/latchset/pkcs11-headers/blob/c5e61990c5621a9b955/public-domain/3.2/pkcs11.h
 */
...
extern CK_RV C_GetMechanismInfo(CK_SLOT_ID, CK_MECHANISM_TYPE, CK_MECHANISM_INFO*);
...
extern CK_RV C_SetPIN(CK_SESSION_HANDLE, CK_UTF8CHAR*, CK_ULONG, CK_UTF8CHAR*, CK_ULONG);
extern CK_RV C_OpenSession(CK_SLOT_ID, CK_FLAGS, void*, CK_NOTIFY, CK_SESSION_HANDLE*);
...
extern CK_RV C_SetOperationState(CK_SESSION_HANDLE, CK_BYTE*, CK_ULONG, CK_OBJECT_HANDLE, CK_OBJECT_HANDLE);
extern CK_RV C_Login(CK_SESSION_HANDLE, CK_USER_TYPE, CK_UTF8CHAR*, CK_ULONG);
extern CK_RV C_Logout(CK_SESSION_HANDLE);
extern CK_RV C_CreateObject(CK_SESSION_HANDLE, CK_ATTRIBUTE*, CK_ULONG, CK_OBJECT_HANDLE*);
extern CK_RV C_CopyObject(CK_SESSION_HANDLE, CK_OBJECT_HANDLE, CK_ATTRIBUTE*, CK_ULONG, CK_OBJECT_HANDLE*);
...
extern CK_RV C_GetAttributeValue(CK_SESSION_HANDLE, CK_OBJECT_HANDLE, CK_ATTRIBUTE*, CK_ULONG);
extern CK_RV C_SetAttributeValue(CK_SESSION_HANDLE, CK_OBJECT_HANDLE, CK_ATTRIBUTE*, CK_ULONG);
extern CK_RV C_FindObjectsInit(CK_SESSION_HANDLE, CK_ATTRIBUTE*, CK_ULONG);
extern CK_RV C_FindObjects(CK_SESSION_HANDLE, CK_OBJECT_HANDLE*, CK_ULONG, CK_ULONG*);
...
extern CK_RV C_Encrypt(CK_SESSION_HANDLE, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*);
extern CK_RV C_EncryptUpdate(CK_SESSION_HANDLE, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*);
...
extern CK_RV C_Decrypt(CK_SESSION_HANDLE, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*);
extern CK_RV C_DecryptUpdate(CK_SESSION_HANDLE, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*);
extern CK_RV C_DecryptFinal(CK_SESSION_HANDLE, CK_BYTE*, CK_ULONG*);
extern CK_RV C_DigestInit(CK_SESSION_HANDLE, CK_MECHANISM*);
extern CK_RV C_Digest(CK_SESSION_HANDLE, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*);
...
extern CK_RV C_Sign(CK_SESSION_HANDLE, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*);
extern CK_RV C_SignUpdate(CK_SESSION_HANDLE, CK_BYTE*, CK_ULONG);
extern CK_RV C_SignFinal(CK_SESSION_HANDLE, CK_BYTE*, CK_ULONG*);
extern CK_RV C_SignRecoverInit(CK_SESSION_HANDLE, CK_MECHANISM*, CK_OBJECT_HANDLE);
extern CK_RV C_SignRecover(CK_SESSION_HANDLE, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*);
extern CK_RV C_VerifyInit(CK_SESSION_HANDLE, CK_MECHANISM*, CK_OBJECT_HANDLE);
extern CK_RV C_Verify(CK_SESSION_HANDLE, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG);
...
extern CK_RV C_VerifyRecoverInit(CK_SESSION_HANDLE, CK_MECHANISM*, CK_OBJECT_HANDLE);
extern CK_RV C_VerifyRecover(CK_SESSION_HANDLE, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*);
extern CK_RV C_DigestEncryptUpdate(CK_SESSION_HANDLE, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*);
extern CK_RV C_DecryptDigestUpdate(CK_SESSION_HANDLE, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*);
extern CK_RV C_SignEncryptUpdate(CK_SESSION_HANDLE, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*);
extern CK_RV C_DecryptVerifyUpdate(CK_SESSION_HANDLE, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*);
extern CK_RV C_GenerateKey(CK_SESSION_HANDLE, CK_MECHANISM*, CK_ATTRIBUTE*, CK_ULONG, CK_OBJECT_HANDLE*);
extern CK_RV C_GenerateKeyPair(CK_SESSION_HANDLE,
                               CK_MECHANISM*,
                               CK_ATTRIBUTE*,
                               CK_ULONG,
                               CK_ATTRIBUTE*,
                               ...
                               CK_OBJECT_HANDLE*,
                               CK_OBJECT_HANDLE*);
extern CK_RV C_WrapKey(CK_SESSION_HANDLE, CK_MECHANISM*, CK_OBJECT_HANDLE, CK_OBJECT_HANDLE, CK_BYTE*, CK_ULONG*);
extern CK_RV C_UnwrapKey(
   CK_SESSION_HANDLE, CK_MECHANISM*, CK_OBJECT_HANDLE, CK_BYTE*, CK_ULONG, CK_ATTRIBUTE*, CK_ULONG, CK_OBJECT_HANDLE*);
...
extern CK_RV C_LoginUser(CK_SESSION_HANDLE, CK_USER_TYPE, CK_UTF8CHAR*, CK_ULONG, CK_UTF8CHAR*, CK_ULONG);
extern CK_RV C_SessionCancel(CK_SESSION_HANDLE, CK_FLAGS);
extern CK_RV C_MessageEncryptInit(CK_SESSION_HANDLE, CK_MECHANISM*, CK_OBJECT_HANDLE);
extern CK_RV C_EncryptMessage(
   CK_SESSION_HANDLE, void*, CK_ULONG, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*);
extern CK_RV C_EncryptMessageBegin(CK_SESSION_HANDLE, void*, CK_ULONG, CK_BYTE*, CK_ULONG);
extern CK_RV C_EncryptMessageNext(
   CK_SESSION_HANDLE, void*, CK_ULONG, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*, CK_FLAGS);
extern CK_RV C_MessageEncryptFinal(CK_SESSION_HANDLE);
extern CK_RV C_MessageDecryptInit(CK_SESSION_HANDLE, CK_MECHANISM*, CK_OBJECT_HANDLE);
extern CK_RV C_DecryptMessage(
   CK_SESSION_HANDLE, void*, CK_ULONG, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*);
extern CK_RV C_DecryptMessageBegin(CK_SESSION_HANDLE, void*, CK_ULONG, CK_BYTE*, CK_ULONG);
extern CK_RV C_DecryptMessageNext(
   CK_SESSION_HANDLE, void*, CK_ULONG, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*, CK_FLAGS);
extern CK_RV C_MessageDecryptFinal(CK_SESSION_HANDLE);
extern CK_RV C_MessageSignInit(CK_SESSION_HANDLE, CK_MECHANISM*, CK_OBJECT_HANDLE);
extern CK_RV C_SignMessage(CK_SESSION_HANDLE, void*, CK_ULONG, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*);
extern CK_RV C_SignMessageBegin(CK_SESSION_HANDLE, void*, CK_ULONG);
extern CK_RV C_SignMessageNext(CK_SESSION_HANDLE, void*, CK_ULONG, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*);
extern CK_RV C_MessageSignFinal(CK_SESSION_HANDLE);
extern CK_RV C_MessageVerifyInit(CK_SESSION_HANDLE, CK_MECHANISM*, CK_OBJECT_HANDLE);
extern CK_RV C_VerifyMessage(CK_SESSION_HANDLE, void*, CK_ULONG, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG);
extern CK_RV C_VerifyMessageBegin(CK_SESSION_HANDLE, void*, CK_ULONG);
extern CK_RV C_VerifyMessageNext(CK_SESSION_HANDLE, void*, CK_ULONG, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG);
extern CK_RV C_MessageVerifyFinal(CK_SESSION_HANDLE);
extern CK_RV C_EncapsulateKey(
   CK_SESSION_HANDLE, CK_MECHANISM*, CK_OBJECT_HANDLE, CK_ATTRIBUTE*, CK_ULONG, CK_BYTE*, CK_ULONG*, CK_OBJECT_HANDLE*);
extern CK_RV C_DecapsulateKey(
   CK_SESSION_HANDLE, CK_MECHANISM*, CK_OBJECT_HANDLE, CK_ATTRIBUTE*, CK_ULONG, CK_BYTE*, CK_ULONG, CK_OBJECT_HANDLE*);
extern CK_RV C_VerifySignatureInit(CK_SESSION_HANDLE, CK_MECHANISM*, CK_OBJECT_HANDLE, CK_BYTE*, CK_ULONG);
...
extern CK_RV C_GetSessionValidationFlags(CK_SESSION_HANDLE, CK_SESSION_VALIDATION_FLAGS_TYPE, CK_FLAGS*);
extern CK_RV C_AsyncComplete(CK_SESSION_HANDLE, CK_UTF8CHAR*, CK_ASYNC_DATA*);
extern CK_RV C_AsyncGetID(CK_SESSION_HANDLE, CK_UTF8CHAR*, CK_ULONG*);
extern CK_RV C_AsyncJoin(CK_SESSION_HANDLE, CK_UTF8CHAR*, CK_ULONG, CK_BYTE*, CK_ULONG);
extern CK_RV C_WrapKeyAuthenticated(
   CK_SESSION_HANDLE, CK_MECHANISM*, CK_OBJECT_HANDLE, CK_OBJECT_HANDLE, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*);
...
typedef CK_RV (*CK_C_WrapKey)(
   CK_SESSION_HANDLE, CK_MECHANISM*, CK_OBJECT_HANDLE, CK_OBJECT_HANDLE, CK_BYTE*, CK_ULONG*);
...
typedef CK_RV (*CK_C_WrapKeyAuthenticated)(
   CK_SESSION_HANDLE, CK_MECHANISM*, CK_OBJECT_HANDLE, CK_OBJECT_HANDLE, CK_BYTE*, CK_ULONG, CK_BYTE*, CK_ULONG*);
typedef CK_RV (*CK_C_UnwrapKeyAuthenticated)(CK_SESSION_HANDLE,
                                             CK_MECHANISM*,
                                             CK_OBJECT_HANDLE,
                                             CK_BYTE*,
                                             CK_ULONG,
