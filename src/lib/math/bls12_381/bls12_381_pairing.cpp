...
Fp12 final_exponentiation(const Fp12& ml) {
   auto f = ml;
   // Possible optimization: f^(p^6) equals f.conjugate() for any Fp12
   // element, and the chained p^2/p^3 Frobenius uses below could be
   // dedicated maps with precomputed coefficients
