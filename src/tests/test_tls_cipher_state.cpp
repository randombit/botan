...
std::vector<Test::Result> test_secret_derivation_rfc8448_rtt0()
   ...
   const auto expected_key_export = Botan::hex_decode_locked(
      "b5 89 bc b4 0b 7f 94 d7 6f 2d d6 fc f9 e5 87 8e");

   // this is not part of RFC 8448
   const std::string early_export_label   = "export_test_label_early";
   const std::string early_export_context = "rfc8448_psk_early";
   const auto early_expected_key_export = Botan::hex_decode_locked(
      "b6 fb 7d 9e b5 4e 97 59 6f e4 ed 93 cc b0 bf 0c");
   ...
   const auto encrypted_extensions = RFC8448_TestData
      ...
      Botan::hex_decode_locked(
         ...
         "9f 98 63 5b c7 a5"),
      Botan::hex_decode_locked(
         "08 00 00 28 00 26 00 0a 00 14 00 12 00 1d 00"
...
BOTAN_REGISTER_TEST_FN("tls", "tls_cipher_state", test_secret_derivation_rfc8448_rtt1, test_secret_derivation_rfc8448_rtt0);
}
