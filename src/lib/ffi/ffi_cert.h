...
BOTAN_FFI_DECLARE_UNIQUE_STRUCT(botan_x509_cert_builder_struct, Botan::CertificateParametersBuilder, 0x8A79DAB7);
BOTAN_FFI_DECLARE_UNIQUE_STRUCT(botan_x509_pkcs10_req_struct, Botan::PKCS10_Request, 0x94C112B6);
BOTAN_FFI_DECLARE_UNIQUE_STRUCT(botan_x509_ext_ip_addr_blocks_struct, Botan::Cert_Extension::IPAddressBlocks, 0xE5A56920);
BOTAN_FFI_DECLARE_UNIQUE_STRUCT(botan_x509_ext_as_blocks_struct, Botan::Cert_Extension::ASBlocks, 0xEF4821D6);
