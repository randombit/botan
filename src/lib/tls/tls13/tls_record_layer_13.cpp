   ...
   public:
      ...
      TLSPlaintext_Header(const Record_Type record_type,
         ...
         , m_serialized(
            ...
            m_legacy_version.major_version(), m_legacy_version.minor_version(),
            get_byte<0>(m_fragment_length), get_byte<1>(m_fragment_length),
            })
         {}
...
Record_Layer::ReadResult<Record> Record_Layer::next_record(Cipher_State* cipher_state)
   ...
   if(cipher_state != nullptr
      && plaintext_header.type() != Record_Type::ApplicationData
