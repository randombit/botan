...
class PCurveInstance final {
   public:
      ...
      static std::shared_ptr<const PrimeOrderCurve> brainpool256t1();
#endif
      ...
      static std::shared_ptr<const PrimeOrderCurve> brainpool384t1();
#endif
      ...
      static std::shared_ptr<const PrimeOrderCurve> brainpool512t1();
#endif
