...
std::vector<Test::Result> test_handshake_state_transitions()
   ...
   return {
      CHECK("uninitialized expects nothing", [](Test::Result& result) {
         ...
         result.confirm("no messages were received", !ht.received_handshake_msg(Botan::TLS::Handshake_Type::ClientHello));
      ...
      CHECK("expect exactly one message", [](Test::Result& result) {
         ...
         result.confirm("received client hello", ht.received_handshake_msg(Botan::TLS::Handshake_Type::ClientHello));
      ...
      CHECK("two expectations can be fulfilled", [](Test::Result& result)
         {
         Botan::TLS::Handshake_Transitions ht;
         ht.set_expected_next({Botan::TLS::Handshake_Type::CertificateRequest,Botan::TLS::Handshake_Type::Certificate});
         ...
         result.confirm("received CERTIFICATE_REQUEST", ht2.received_handshake_msg(Botan::TLS::Handshake_Type::CertificateRequest));
         }),
