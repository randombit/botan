...
class PKCS12_Tests final : public Test {
   ...
   private:
      ...
      Test::Result test_empty_password() {
         ...
         // protection - also with a MAC and/or certificate encryption enabled.
         std::vector<Botan::PKCS12_Export_Options> configs;
         configs.push_back(Botan::PKCS12_Export_Options::legacy_compat("").without_mac());
         configs.push_back(Botan::PKCS12_Export_Options::legacy_compat(""));
         configs.push_back(Botan::PKCS12_Export_Options::legacy_compat("").with_cert_encryption_algo("PBE-SHA1-3DES"));
