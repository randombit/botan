    ...
    */
    class EC_PublicKey : public virtual Public_Key
      ...
      public:
        ...
        */
        inline Botan::math::ec::PointGFp get_public_point() const
          {
        ...
        */
        ...
        /**
        * Get a cvc encoder that can be used to encode this key.
        * @result a cvc encoder for this key
        */
        std::auto_ptr<EAC1_1_CVC_Encoder> cvc_eac1_1_encoder() const;
        /**
        * Get a cvc decoder that can be used to decode a stored key into
        * this key.
        * @result a cvc decoder for this key
        */
        std::auto_ptr<EAC1_1_CVC_Decoder> cvc_eac1_1_decoder();
      ...
      protected:
		...
		std::auto_ptr<Botan::math::ec::PointGFp> mp_public_point;
    ...
    */
    class ECDSA_PublicKey : public virtual EC_PublicKey, public PK_Verifying_wo_MR_Key
       ...
       */
        ...
        */
        ECDSA_PublicKey(EC_Domain_Params const& dom_par, Botan::math::ec::PointGFp const& public_point); // sets core
        void X509_load_hook();
    ...
    */
    class ECDSA_PrivateKey : public ECDSA_PublicKey, public EC_PrivateKey, public PK_Signing_Key
      ...
      public:
        ...
        */
        ECDSA_PrivateKey(EC_Domain_Params const& dom_pars)
        {
...
#ifdef TA_COLL_T
        /**
         * for purposes of testing the resistance against timing attacks on the computation of s
         * in the signing operation
         */
        ECDSA_PrivateKey(BigInt const& priv_key, EC_Domain_Params const& dom_pars)
        {
          mp_dom_pars = std::auto_ptr<EC_Domain_Params>(new EC_Domain_Params(dom_pars));
          if (mp_dom_pars->get_order() <= priv_key)
            {
              throw Invalid_Argument("private key value larger than base point order");
            }
          m_private_value = priv_key;
          mp_public_point = std::auto_ptr<Botan::math::ec::PointGFp>( new Botan::math::ec::PointGFp (mp_dom_pars->get_base_point()));
          mp_public_point->mult_this_secure(m_private_value, mp_dom_pars->get_order(), mp_dom_pars->get_order()-1);
          assert(mp_public_point.get() != 0);
          mp_public_point->check_invariants();
          m_ecdsa_core = ECDSA_Core(*mp_dom_pars, m_private_value, *mp_public_point);
        }
    ...
    */
    class ECKAEG_PublicKey : public virtual EC_PublicKey
      ...
      /**
        ...
        * @param public_point the public point defining this key
        */
        ECKAEG_PublicKey(EC_Domain_Params const& dom_par, Botan::math::ec::PointGFp const& public_point);
    ...
    class ECKAEG_PrivateKey : public ECKAEG_PublicKey, public EC_PrivateKey, public PK_Key_Agreement_Key
      ...
      /**
        ...
        * @param the domain parameters to used for this key
        */
        ECKAEG_PrivateKey(EC_Domain_Params const& dom_pars)
        {
          mp_dom_pars = std::auto_ptr<EC_Domain_Params>(new EC_Domain_Params(dom_pars));
          generate_private_key();
          mp_public_point->check_invariants();
