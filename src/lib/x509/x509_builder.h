...
*/
class BOTAN_PUBLIC_API(3, 14) CertificateParametersBuilder final {
   public:
      ...
      * Add an additional email address to the certificate metadata
      *
      * @throws Invalid_Argument if @p email cannot be parsed
      */
      ...
      * Add an additional URI to the certificate metadata
      *
      * @throws Invalid_Argument if @p uri cannot be parsed
      */
      ...
      * Add an additional DNS name to the certificate metadata
      *
      * @throws Invalid_Argument if @p dns cannot be parsed
      */
