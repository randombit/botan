...
class BOTAN_PUBLIC_API(3, 8) KeyEncryptionOptions final {
   public:
      ...
      */
      KeyEncryptionOptions(std::chrono::milliseconds pwhash_duration) :
...
class BOTAN_PUBLIC_API(3, 8) EncryptedPrivateKey final {
   public:
