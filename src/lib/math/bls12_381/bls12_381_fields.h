...
class BOTAN_TEST_API FieldElement final {
   public:
      ...
      /**
      * Return the multiplicative inverse of this element, or zero for zero
      */
      ...
      * is unspecified.
      */
      CT::Option<FieldElement> sqrt() const;
      ...
      */
      void conditional_assign(CT::Choice cnd, const FieldElement& other);
...
class BOTAN_TEST_API FieldElement2 final {
   public:
      ...
      */
      ...
      // Squaring in place for fixed addition chains
      void square_n(size_t n);
      ...
      * is unspecified.
      */
      CT::Option<FieldElement2> sqrt() const;
      ...
      * If cnd is set assign other to this, in constant time
      */
      void conditional_assign(CT::Choice cnd, const FieldElement2& other);
...
/**
* Generic MSB-first exponentiation with a fixed public exponent
*
* Since every exponent used is a fixed constant, each user could
* instead use an addchain generated chain (as invert does), reducing
* the multiplication count roughly 3x; the sqrts during G1 and
* especially G2 deserialization would benefit the most.
*/
