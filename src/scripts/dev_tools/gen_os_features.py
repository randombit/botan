...
def update_os():
    ...
    print(".. This file was automatically generated by src/scripts/dev_tools/%s on %s"
                    % (os.path.basename(sys.argv[0]), today), file=f1)
    print(".. All manual changes will be lost. Edit the script instead.", file=f1)
    print(file=f1)
