...
* OID maps
*
* This file was automatically generated by ./src/scripts/dev_tools/gen_oids.py on 2025-04-03
*
...
std::unordered_map<std::string, OID> OID_Map::load_str2oid_map() {
   std::pair<const char*, std::vector<uint32_t>> oid_maps[] = {
      ...
      {"OunsworthKEMCombiner/FrodoKEM-1344-SHAKE/ECDH-brainpool512r1/KMAC-256", {1, 3, 6, 1, 4, 1, 25258, 1, 20, 8}},
      {"OunsworthKEMCombiner/FrodoKEM-640-SHAKE/ECDH-brainpool256r1/KMAC-128", {1, 3, 6, 1, 4, 1, 25258, 1, 20, 6}},
      {"OunsworthKEMCombiner/FrodoKEM-976-SHAKE/ECDH-brainpool384r1/KMAC-256", {1, 3, 6, 1, 4, 1, 25258, 1, 20, 7}},
      {"OunsworthKEMCombiner/Kyber-1024-r3/ECDH-secp521r1/KMAC-256", {1, 3, 6, 1, 4, 1, 25258, 1, 20, 5}},
      {"OunsworthKEMCombiner/Kyber-1024-r3/X448/KMAC-256", {1, 3, 6, 1, 4, 1, 25258, 1, 20, 2}},
      {"OunsworthKEMCombiner/Kyber-512-r3/ECDH-secp256r1/KMAC-128", {1, 3, 6, 1, 4, 1, 25258, 1, 20, 3}},
      {"OunsworthKEMCombiner/Kyber-768-r3/ECDH-secp384r1/KMAC-256", {1, 3, 6, 1, 4, 1, 25258, 1, 20, 4}},
      {"OunsworthKEMCombiner/Kyber-768-r3/X25519/KMAC-256", {1, 3, 6, 1, 4, 1, 25258, 1, 20, 1}},
