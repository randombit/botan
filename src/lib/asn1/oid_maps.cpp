...
* OID maps
*
* This file was automatically generated by ./src/scripts/dev_tools/gen_oids.py on 2025-01-25
*
...
std::unordered_map<OID, std::string> OID_Map::load_oid2str_map() {
   return std::unordered_map<OID, std::string>{
      ...
      {OID({1, 2, 156, 10197, 1, 504}), "RSA/EMSA3(SM3)"},
      ...
      {OID({1, 2, 840, 113549, 1, 1, 10}), "RSA/EMSA4"},
      {OID({1, 2, 840, 113549, 1, 1, 11}), "RSA/EMSA3(SHA-256)"},
      {OID({1, 2, 840, 113549, 1, 1, 12}), "RSA/EMSA3(SHA-384)"},
      {OID({1, 2, 840, 113549, 1, 1, 13}), "RSA/EMSA3(SHA-512)"},
      {OID({1, 2, 840, 113549, 1, 1, 14}), "RSA/EMSA3(SHA-224)"},
      {OID({1, 2, 840, 113549, 1, 1, 16}), "RSA/EMSA3(SHA-512-256)"},
      {OID({1, 2, 840, 113549, 1, 1, 2}), "RSA/EMSA3(MD2)"},
      {OID({1, 2, 840, 113549, 1, 1, 4}), "RSA/EMSA3(MD5)"},
      {OID({1, 2, 840, 113549, 1, 1, 5}), "RSA/EMSA3(SHA-1)"},
      ...
      {OID({1, 3, 36, 3, 3, 1, 2}), "RSA/EMSA3(RIPEMD-160)"},
      ...
      {OID({2, 16, 840, 1, 101, 3, 4, 3, 13}), "RSA/EMSA3(SHA-3(224))"},
      {OID({2, 16, 840, 1, 101, 3, 4, 3, 14}), "RSA/EMSA3(SHA-3(256))"},
      {OID({2, 16, 840, 1, 101, 3, 4, 3, 15}), "RSA/EMSA3(SHA-3(384))"},
      {OID({2, 16, 840, 1, 101, 3, 4, 3, 16}), "RSA/EMSA3(SHA-3(512))"},
