...
Fp12 Fp12::frobenius_map() const {
   ...
   // c1 *= (u+1)^((p-1)/6), scaling each Fp2 coefficient directly
   return Fp12(c0, Fp6(c1.c0() * FP12_FROBENIUS_C1, c1.c1() * FP12_FROBENIUS_C1, c1.c2() * FP12_FROBENIUS_C1));
}
...
void Fp12::conditional_assign(CT::Choice cnd, const Fp12& other) {
