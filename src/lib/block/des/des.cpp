...
inline uint32_t spbox(uint32_t T0, uint32_t T1)
   {
   return DES_SPBOX1[get_byte(0, T0) % 64] ^
          DES_SPBOX2[get_byte(0, T1) % 64] ^
          DES_SPBOX3[get_byte(1, T0) % 64] ^
          DES_SPBOX4[get_byte(1, T1) % 64] ^
          DES_SPBOX5[get_byte(2, T0) % 64] ^
          DES_SPBOX6[get_byte(2, T1) % 64] ^
          DES_SPBOX7[get_byte(3, T0) % 64] ^
          DES_SPBOX8[get_byte(3, T1) % 64];
   }
