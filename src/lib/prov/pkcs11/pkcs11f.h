...
(CK_SESSION_HANDLE hSession,   /* the session's handle */
 ...
 /* the wrapped key */       /* TODO: was pCiphertextKey , not matching with length variable */
...
CK_PKCS11_FUNCTION_INFO(C_GetSessionValidationFlags)
      #ifdef CK_NEED_ARG_LIST
(CK_SESSION_HANDLE hSession, /* the session's handle */
 CK_ULONG /* CK_SESSION_VALIDATION_FLAGS_TYPE */ type,
 /* which state of flags */              /* CK_SESSION_VALIDATION_FLAGS_TYPE currently not in header !!! */
