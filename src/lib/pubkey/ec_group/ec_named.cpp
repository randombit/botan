/*
* ECC Group Info
* This file was automatically generated using ./src/scripts/gen_ec_groups.py on 2021-03-13
*
...
std::shared_ptr<EC_Group_Data> EC_Group::EC_group_info(const OID& oid) {
   ...
   // gost_256A
   if(oid == OID{1, 2, 643, 7, 1, 2, 1, 1, 1} || oid == OID{1, 2, 643, 2, 2, 35, 1} ||
      oid == OID{1, 2, 643, 2, 2, 36, 0})
...
OID EC_Group::EC_group_identity_from_order(const BigInt& order) {
   ...
   if(low_bits == 0x44C59311 &&
      order == BigInt("0xD35E472036BC4FB7E13C785ED201E065F98FCFA5B68F12A32D482EC7EE8658E98691555B44C59311"))
      return OID{1, 3, 36, 3, 3, 2, 8, 1, 1, 9};

   if(low_bits == 0xE9046565 &&
      order ==
         BigInt("0x8CB91E82A3386D280F5D6F7E50E641DF152F7109ED5456B31F166E6CAC0425A7CF3AB6AF6B7FC3103B883202E9046565"))
      return OID{1, 3, 36, 3, 3, 2, 8, 1, 1, 11};

   if(low_bits == 0x9CA90069 &&
      order ==
         BigInt(
            "0xAADD9DB8DBE9C48B3FD4E6AE33C9FC07CB308DB3B3C9D20ED6639CCA70330870553E5C414CA92619418661197FAC10471DB1D381085DDADDB58796829CA90069"))
...
const std::set<std::string>& EC_Group::known_named_groups() {
   static const std::set<std::string> named_groups = {
      "brainpool160r1", "brainpool192r1", "brainpool224r1", "brainpool256r1", "brainpool320r1", "brainpool384r1",
      "brainpool512r1", "frp256v1",       "gost_256A",      "gost_512A",      "secp160k1",      "secp160r1",
      "secp160r2",      "secp192k1",      "secp192r1",      "secp224k1",      "secp224r1",      "secp256k1",
      "secp256r1",      "secp384r1",      "secp521r1",      "sm2p256v1",      "x962_p192v2",    "x962_p192v3",
      "x962_p239v1",    "x962_p239v2",    "x962_p239v3",
   };
   return named_groups;
}
