   ...
   return {
      CHECK("default address",
            [&](Test::Result& result) {
               ...
               result.test_bin_eq(
                  "SHA-256(32*0x00)", sha256(a), "66687aadf862bd776c8fc18b8e9f8e20089714856ee233b3902a591d0d5f2925");
            }),
      ...
      CHECK("set up an address",
            [&](Test::Result& result) {
               ...
               result.test_bin_eq(
                  "SHA-256(a1)", sha256(a), "aecc0696fee5c4aa601779343d01090aae0d0a3b6cf118d3c7245d48dc0f3af9");
            }),
      ...
      CHECK("set up another address",
            [&](Test::Result& result) {
               ...
               result.test_bin_eq(
                  "SHA-256(a2)", sha256(a), "607fdc9d063168fbea64e4da2a255693314712d859062abb80cf7c78116ded2a");
            }),
      ...
      CHECK("copy subtree",
            [&](Test::Result& result) {
               ...
               result.test_bin_eq("SHA-256(subtree1)",
                                  sha256(subtree1),
                                  "f192c8f8e946aa16d16eafe88bd4eabcc88a305b69bb7c0bb49e65bd122bb973");
               result.test_bin_eq("SHA-256(subtree2)",
                                  sha256(subtree2),
                                  "f192c8f8e946aa16d16eafe88bd4eabcc88a305b69bb7c0bb49e65bd122bb973");
            }),
      ...
      CHECK("copy keypair",
            [&](Test::Result& result) {
               ...
               result.test_bin_eq("SHA-256(keypair1)",
                                  sha256(keypair1),
                                  "1cdd4835a6057306678e7d8cb903c140aba1d4805a8a1f75b11f1129bb22d08c");
               result.test_bin_eq("SHA-256(keypair2)",
                                  sha256(keypair2),
                                  "1cdd4835a6057306678e7d8cb903c140aba1d4805a8a1f75b11f1129bb22d08c");
            }),
   };
