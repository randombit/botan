   ...
   private:
      ...
      class Test_Callbacks final : public Botan::TLS::Callbacks {
         public:
            ...
            std::unique_ptr<Botan::PK_Key_Agreement_Key> tls_generate_ephemeral_ecdh_key(
               ...
               return Botan::TLS::Callbacks::tls_generate_ephemeral_ecdh_key(
      ...
      void test_custom_ecdh_provider(std::vector<Test::Result>& results,
         ...
         for(Botan::TLS::Group_Params ecdh_group : groups) {
            ...
            test.set_custom_client_tls_generate_ephemeral_ecdh_key_callback(
               [&generator_called](const Botan::TLS::Group_Params& group,
                                   Botan::RandomNumberGenerator&,
            ...
            test.set_custom_client_tls_ephemeral_key_agreement_callback(
               [&agreement_called](const std::variant<Botan::TLS::Group_Params, Botan::DL_Group>&,
                                   const Botan::PK_Key_Agreement_Key& private_key,
                  ...
                  if(!hwkey) {
                     throw Botan::Invalid_Argument("Expected custom ECDH wrapper class");
                  }
