...
#if defined(BOTAN_HAS_SHACAL2_SIMD8X32)
      void simd8x32_encrypt_8(const uint8_t in[], uint8_t out[]) const;
      void simd8x32_decrypt_8(const uint8_t in[], uint8_t out[]) const;
#endif
