...
std::vector<Test::Result> read_handshake_messages()
   ...
   return
      ...
      Botan_Tests::CHECK("reject TLS 1.2 messages", [&](auto& result)
         {
      ...
      Botan_Tests::CHECK("reject incomplete messages with invalid type", [&](auto& result)
         {
...
std::vector<Test::Result> full_client_handshake()
   ...
   return
      ...
      Botan_Tests::CHECK("server handshake messages", [&](auto& result)
         {
      ...
      Botan_Tests::CHECK("client finished", [&](auto& result)
         {
...
std::vector<Test::Result> hello_retry_request_handshake()
   ...
   return
      ...
      Botan_Tests::CHECK("hello retry request", [&](auto& result)
         {
