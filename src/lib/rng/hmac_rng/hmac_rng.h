...
class BOTAN_DLL HMAC_RNG final : public Stateful_RNG
   ...
   public:
      ...
      * @param max_output_before_reseed specifies a limit of how many bytes
      * will be output before the generator is reseeded.
      */
      ...
      */
      ...
      size_t security_level() const override { return m_prf->output_length() * 8; }
