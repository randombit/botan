/*
* ECC Group Info
* This file was automatically generated by ./src/scripts/dev_tools/gen_ec_groups.py on 2026-05-08
...
std::shared_ptr<EC_Group_Data> EC_Group::EC_group_info(const OID& oid) {
   ...
   // brainpool256t1
   if(oid == OID{1, 3, 36, 3, 3, 2, 8, 1, 1, 8}) {
      return load_EC_group_info(
         "0xA9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5377",
   ...
   // brainpool384t1
   if(oid == OID{1, 3, 36, 3, 3, 2, 8, 1, 1, 12}) {
      return load_EC_group_info(
         "0x8CB91E82A3386D280F5D6F7E50E641DF152F7109ED5456B412B1DA197FB71123ACD3A729901D1A71874700133107EC53",
   ...
   // brainpool512t1
   if(oid == OID{1, 3, 36, 3, 3, 2, 8, 1, 1, 14}) {
      return load_EC_group_info(
         "0xAADD9DB8DBE9C48B3FD4E6AE33C9FC07CB308DB3B3C9D20ED6639CCA703308717D4D9B009BC66842AECDA12AE6A380E62881FF2F2D82C68528AA6056583A48F3",
...
OID EC_Group::EC_group_identity_from_order(const BigInt& order)
   ...
   if(low_bits == 0x974856A7 && order == BigInt("0xA9FB57DBA1EEA9BC3E660A909D838D718C397AA3B561A6F7901E0E82974856A7")) {
      return OID{1, 3, 36, 3, 3, 2, 8, 1, 1, 8};
   }
   ...
   if(low_bits == 0xE9046565 && order == BigInt("0x8CB91E82A3386D280F5D6F7E50E641DF152F7109ED5456B31F166E6CAC0425A7CF3AB6AF6B7FC3103B883202E9046565")) {
      return OID{1, 3, 36, 3, 3, 2, 8, 1, 1, 12};
   }
   ...
   if(low_bits == 0x9CA90069 && order == BigInt("0xAADD9DB8DBE9C48B3FD4E6AE33C9FC07CB308DB3B3C9D20ED6639CCA70330870553E5C414CA92619418661197FAC10471DB1D381085DDADDB58796829CA90069")) {
      return OID{1, 3, 36, 3, 3, 2, 8, 1, 1, 14};
   }
...
#if defined(BOTAN_HAS_PCURVES_BRAINPOOL256T1) || defined(BOTAN_HAS_LEGACY_EC_POINT) || defined(BOTAN_HAS_PCURVES_GENERIC)
      "brainpool256t1",
#endif
...
#if defined(BOTAN_HAS_PCURVES_BRAINPOOL384T1) || defined(BOTAN_HAS_LEGACY_EC_POINT) || defined(BOTAN_HAS_PCURVES_GENERIC)
      "brainpool384t1",
#endif
...
#if defined(BOTAN_HAS_PCURVES_BRAINPOOL512T1) || defined(BOTAN_HAS_LEGACY_EC_POINT) || defined(BOTAN_HAS_PCURVES_GENERIC)
      "brainpool512t1",
#endif
