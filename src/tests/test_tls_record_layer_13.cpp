...
std::unique_ptr<TLS::Cipher_State> rfc8448_rtt1_handshake_traffic(Botan::TLS::Connection_Side side = Botan::TLS::Connection_Side::Client)
   ...
   return TLS::Cipher_State::init_with_server_hello(
             side, std::move(shared_secret), cipher, transcript_hash);
   }
...
std::vector<Test::Result> read_full_records()
   ...
   return
      {
      Botan_Tests::CHECK("change cipher spec", [&](auto& result)
         {
      ...
      Botan_Tests::CHECK("two CCS messages", [&](auto& result)
         {
      ...
      Botan_Tests::CHECK("read full handshake message", [&](auto& result)
         {
         auto rl = record_layer_server();
...
std::vector<Test::Result> basic_sanitization_parse_records(TLS::Connection_Side side)
   ...
   return
      {
      Botan_Tests::CHECK("'receive' empty data", [&](auto& result)
         {
      ...
      Botan_Tests::CHECK("incomplete header asks for more data", [&](auto& result)
         {
      ...
      Botan_Tests::CHECK("complete header asks for enough data to finish processing the record", [&](auto& result)
         {
      ...
      Botan_Tests::CHECK("received an empty record (that is not application data)", [&](auto& result)
         {
      ...
      Botan_Tests::CHECK("received the maximum size of an unprotected record", [&](auto& result)
         {
      ...
      Botan_Tests::CHECK("received too many bytes in one protected record", [&](auto& result)
         {
      ...
      Botan_Tests::CHECK("decryption would result in too large plaintext", [&](auto& result)
         {
      ...
      Botan_Tests::CHECK("received too many bytes in one unprotected record", [&](auto& result)
         {
      ...
      Botan_Tests::CHECK("invalid record type", [&](auto& result)
         {
      ...
      Botan_Tests::CHECK("invalid record version", [&](auto& result)
         {
...
std::vector<Test::Result> read_fragmented_records()
   ...
   return
      {
      Botan_Tests::CHECK("change cipher spec in many small pieces", [&](auto& result)
         {
...
std::vector<Test::Result> write_records()
   ...
   return
      ...
      Botan_Tests::CHECK("prepare a client hello", [&](auto& result)
         {
      ...
      Botan_Tests::CHECK("cannot prepare non-dummy CCS", [&](auto& result)
         {
...
read_encrypted_records()
   ...
   return
      {
      Botan_Tests::CHECK("read encrypted server hello extensions", [&](Test::Result &result)
         {
         auto cs = rfc8448_rtt1_handshake_traffic();
      ...
      Botan_Tests::CHECK("premature application data", [&](Test::Result &result)
         {
         auto rl = record_layer_client(true);
      ...
      Botan_Tests::CHECK("decryption fails due to bad MAC", [&](Test::Result &result)
         {
      ...
      Botan_Tests::CHECK("decryption fails due to too short record", [&](Test::Result &result)
         {
      ...
      Botan_Tests::CHECK("protected Change Cipher Spec message is illegal", [&](Test::Result& result)
         {
      ...
      Botan_Tests::CHECK("unprotected CCS is legal when encrypted traffic is expected", [&](Test::Result& result)
         {
         const auto ccs_record = Botan::hex_decode("14 03 03 00 01 01");
      ...
      Botan_Tests::CHECK("read fragmented application data", [&](Test::Result& result)
         {
      ...
      Botan_Tests::CHECK("read coalesced server hello and encrypted extensions", [&](Test::Result& result)
         {
...
std::vector<Test::Result> write_encrypted_records()
   ...
   return
      {
      Botan_Tests::CHECK("write encrypted client handshake finished", [&](Test::Result& result)
         {
      ...
      Botan_Tests::CHECK("write a lot of data producing two protected records", [&](Test::Result& result)
         ...
         auto ct = record_layer_client(true).prepare_records(TLS::Record_Type::ApplicationData,
                   big_data, cs.get());
         ...
         auto read_record_header = [&](auto &reader)
            {
            result.test_is_eq("APPLICATION_DATA", reader.get_byte(), static_cast<uint8_t>(TLS::Record_Type::ApplicationData));
...
std::vector<Test::Result> legacy_version_handling()
   ...
   return
      {
      Botan_Tests::CHECK("client side starts with version 0x0301", [&](Test::Result& result)
         {
         auto rl = record_layer_client();
      ...
      Botan_Tests::CHECK("server side starts with version 0x0303", [&](Test::Result& result)
         {
      ...
      Botan_Tests::CHECK("server side accepts version 0x0301 for the first record", [&](Test::Result& result)
         {
      ...
      Botan_Tests::CHECK("server side accepts version 0x0301 for the first record for partial records", [&](Test::Result& result)
         {
      ...
      Botan_Tests::CHECK("server side accepts version 0x0303 for the first record", [&](Test::Result& result)
         {
...
std::vector<Test::Result> record_size_limits()
   ...
   return
      ...
      Botan_Tests::CHECK("no specified limits means protocol defaults", [&](Test::Result& result)
         ...
         const auto r1 = rlc.prepare_records(TLS::Record_Type::ApplicationData, std::vector<uint8_t>(Botan::TLS::MAX_PLAINTEXT_SIZE), csc.get());
         result.test_eq("one record generated", count_records(r1), 1);

         const auto r2 = rlc.prepare_records(TLS::Record_Type::ApplicationData, std::vector<uint8_t>(Botan::TLS::MAX_PLAINTEXT_SIZE + 1), csc.get());
         ...
         result.test_eq("correct length record", record_length(result, rls.next_record(css.get())), Botan::TLS::MAX_PLAINTEXT_SIZE);
         }),

      Botan_Tests::CHECK("outgoing record size limit", [&](Test::Result& result)
         {
         auto cs = rfc8448_rtt1_handshake_traffic();
         auto rl = record_layer_client(true);
      ...
      Botan_Tests::CHECK("outgoing record size limit can be changed", [&](Test::Result& result)
         {
         auto cs = rfc8448_rtt1_handshake_traffic();
         auto rl = record_layer_client(true);

         const auto r1 = rl.prepare_records(TLS::Record_Type::ApplicationData, std::vector<uint8_t>(Botan::TLS::MAX_PLAINTEXT_SIZE), cs.get());
         result.test_eq("one record generated", count_records(r1), 1);

         const auto r2 = rl.prepare_records(TLS::Record_Type::ApplicationData, std::vector<uint8_t>(Botan::TLS::MAX_PLAINTEXT_SIZE + 1), cs.get());
         result.test_eq("two records generated", count_records(r2), 2);
      ...
      Botan_Tests::CHECK("outgoing record limit does not affect unencrypted records", [&](Test::Result& result)
         {
         auto rl = record_layer_client(true);

         rl.set_record_size_limits(127 + 1 /* content type byte */, Botan::TLS::MAX_PLAINTEXT_SIZE + 1);

         const auto r1 = rl.prepare_records(TLS::Record_Type::Handshake, std::vector<uint8_t>(Botan::TLS::MAX_PLAINTEXT_SIZE));
         result.test_eq("one record generated", count_records(r1), 1);

         const auto r2 = rl.prepare_records(TLS::Record_Type::Handshake, std::vector<uint8_t>(Botan::TLS::MAX_PLAINTEXT_SIZE + 1));
         result.test_eq("two records generated", count_records(r2), 2);
         }),

      Botan_Tests::CHECK("incoming limit is not checked on unprotected records", [&](Test::Result& result)
         {
         auto rlc = record_layer_client(true);
      ...
      Botan_Tests::CHECK("incoming limit is checked on protected records", [&](Test::Result& result)
         ...
         rls.copy_data(Botan::hex_decode(
            "170303009061ec4de29020a5664ef670094c7b5daa2796aa52e128cfa8808d15c1"
         ...
         rls.copy_data(Botan::hex_decode(
            "1703030091234d4a480092fa6a55f1443345ee8d2250cd9c676370be68f86234db"
         ...
         result.test_throws("overflow detected", "Received an encrypted record that exceeds maximum plaintext size",
