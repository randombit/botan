   ...
   static const std::unordered_map<std::string, std::string> err_map
      {
         ...
         { "Unexpected state transition in handshake got a finished expected certificate_verify seen client_hello+certificate", ":UNEXPECTED_MESSAGE:" },
         { "Unexpected state transition in handshake got a finished expected certificate seen client_hello", ":UNEXPECTED_MESSAGE:" },
