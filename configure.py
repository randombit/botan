...
def create_template_vars(source_paths, build_paths, options, modules, cc, arch, osinfo):
    ...
    variables = {
        ...
        'bindir': options.bindir or os.path.join(options.prefix or osinfo.install_root, osinfo.bin_dir),
        'libdir': options.libdir or os.path.join(options.prefix or osinfo.install_root, osinfo.lib_dir),
