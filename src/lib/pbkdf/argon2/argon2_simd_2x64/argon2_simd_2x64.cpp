...
BOTAN_SIMD_2X64_ISA_FUNC BOTAN_FORCE_INLINE void blamka_G(SIMD_2x64& A0,
                                                          SIMD_2x64& A1,
                                                          SIMD_2x64& B0,
                                                          SIMD_2x64& B1,
                                                          SIMD_2x64& C0,
...
BOTAN_SIMD_2X64_ISA_FUNC BOTAN_FORCE_INLINE void blamka_R(SIMD_2x64& A0,
                                                          SIMD_2x64& A1,
                                                          SIMD_2x64& B0,
                                                          SIMD_2x64& B1,
                                                          SIMD_2x64& C0,
...
BOTAN_SIMD_2X64_ISA_FUNC void argon2_blamka_simd_2x64(uint64_t N[128], uint64_t T[128]) {
...
void Argon2::blamka_simd_2x64(uint64_t N[128], uint64_t T[128]) {
   return argon2_blamka_simd_2x64(N, T);
}
