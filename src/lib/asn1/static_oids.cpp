/*
* This file was automatically generated by ./src/scripts/dev_tools/gen_oids.py on 2026-05-08
...
std::optional<std::string_view> OID_Map::lookup_static_oid(const OID& oid) {
   ...
   switch(hc) {
      ...
      case 0x9A00F:
         return if_match(oid, {1, 3, 36, 3, 3, 2, 8, 1, 1, 8}, "brainpool256t1");
      case 0x9A010:
         return if_match(oid, {1, 3, 36, 3, 3, 2, 8, 1, 1, 9}, "brainpool320r1");
      case 0x9A012:
         return if_match(oid, {1, 3, 36, 3, 3, 2, 8, 1, 1, 11}, "brainpool384r1");
      case 0x9A013:
         return if_match(oid, {1, 3, 36, 3, 3, 2, 8, 1, 1, 12}, "brainpool384t1");
      case 0x9A014:
         return if_match(oid, {1, 3, 36, 3, 3, 2, 8, 1, 1, 13}, "brainpool512r1");
      case 0x9A015:
         return if_match(oid, {1, 3, 36, 3, 3, 2, 8, 1, 1, 14}, "brainpool512t1");
      case 0xA0D61:
...
std::optional<OID> OID_Map::lookup_static_oid_name(std::string_view req) {
   ...
   switch(hc) {
      ...
      case 0x70DAC:
         return if_match(req, "brainpool384t1", {1, 3, 36, 3, 3, 2, 8, 1, 1, 12});
      case 0x70EA6:
      ...
      case 0x76C0F:
         return if_match(req, "brainpool512t1", {1, 3, 36, 3, 3, 2, 8, 1, 1, 14});
      case 0x77254:
      ...
      case 0xC44C0:
         return if_match(req, "brainpool256t1", {1, 3, 36, 3, 3, 2, 8, 1, 1, 8});
      default:
         return {};
   }
}
