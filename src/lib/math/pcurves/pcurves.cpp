...
#if defined(BOTAN_HAS_PCURVES_BRAINPOOL256T1)
   if(name == "brainpool256t1") {
      return PCurveInstance::brainpool256t1();
   }
#endif
...
#if defined(BOTAN_HAS_PCURVES_BRAINPOOL384T1)
   if(name == "brainpool384t1") {
      return PCurveInstance::brainpool384t1();
   }
#endif
...
#if defined(BOTAN_HAS_PCURVES_BRAINPOOL512T1)
   if(name == "brainpool512t1") {
      return PCurveInstance::brainpool512t1();
   }
#endif
