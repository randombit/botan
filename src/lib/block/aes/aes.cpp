...
inline uint8_t xtime(uint8_t s)
   {
   return (s << 1) ^ ((s >> 7) * 0x1B);
   }
inline uint8_t xtime4(uint8_t s)
   {
   return xtime(xtime(s));
   }
inline uint8_t xtime8(uint8_t s)
   {
   return xtime(xtime(xtime(s)));
   }

inline uint8_t xtime3(uint8_t s)
   {
   return xtime(s) ^ s;
   }
inline uint8_t xtime9(uint8_t s)
   {
   return xtime8(s) ^ s;
   }
inline uint8_t xtime11(uint8_t s)
   {
   return xtime8(s) ^ xtime(s) ^ s;
   }
inline uint8_t xtime13(uint8_t s)
   {
   return xtime8(s) ^ xtime4(s) ^ s;
   }
inline uint8_t xtime14(uint8_t s)
   {
