...
* OID maps
*
* This file was automatically generated by ./src/scripts/oids.py on 2023-01-18
*
...
std::unordered_map<std::string, std::string> OIDS::load_oid2str_map()
   ...
   return std::unordered_map<std::string,std::string>{
      ...
      { "1.2.840.10040.4.3", "DSA/EMSA1(SHA-1)" },
      ...
      { "1.2.840.10045.4.1", "ECDSA/EMSA1(SHA-1)" },
      ...
      { "1.3.36.3.3.2.5.4.2", "ECGDSA/EMSA1(SHA-1)" },
      ...
      { "1.3.6.1.4.1.25258.1.10.1", "Dilithium-AES-r3/4x4" },
      { "1.3.6.1.4.1.25258.1.10.2", "Dilithium-AES-r3/6x5" },
      { "1.3.6.1.4.1.25258.1.10.3", "Dilithium-AES-r3/8x7" },
      ...
      { "1.3.6.1.4.1.25258.1.9.1", "Dilithium-r3/4x4" },
      { "1.3.6.1.4.1.25258.1.9.2", "Dilithium-r3/6x5" },
      { "1.3.6.1.4.1.25258.1.9.3", "Dilithium-r3/8x7" },
...
std::unordered_map<std::string, OID> OIDS::load_str2oid_map()
   ...
   return std::unordered_map<std::string,OID>{
      ...
      { "DSA/EMSA1(SHA-1)", OID({1,2,840,10040,4,3}) },
      ...
      { "Dilithium-AES-r3/4x4", OID({1,3,6,1,4,1,25258,1,10,1}) },
      { "Dilithium-AES-r3/6x5", OID({1,3,6,1,4,1,25258,1,10,2}) },
      { "Dilithium-AES-r3/8x7", OID({1,3,6,1,4,1,25258,1,10,3}) },
      { "Dilithium-r3/4x4", OID({1,3,6,1,4,1,25258,1,9,1}) },
      { "Dilithium-r3/6x5", OID({1,3,6,1,4,1,25258,1,9,2}) },
      { "Dilithium-r3/8x7", OID({1,3,6,1,4,1,25258,1,9,3}) },
      { "ECDH", OID({1,3,132,1,12}) },
      { "ECDSA", OID({1,2,840,10045,2,1}) },
      { "ECDSA/EMSA1(SHA-1)", OID({1,2,840,10045,4,1}) },
      ...
      { "ECGDSA/EMSA1(SHA-1)", OID({1,3,36,3,3,2,5,4,2}) },
