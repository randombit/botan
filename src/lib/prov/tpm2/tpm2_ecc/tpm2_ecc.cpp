...
SignatureAlgorithmSelection make_signature_scheme(const PK_Signature_Options_Reader& options) {
...
class EC_Signature_Operation final : public Signature_Operation {
   public:
      EC_Signature_Operation(const Object& object,
                             const SessionBundle& sessions,
...
std::unique_ptr<PK_Ops::Verification> EC_PublicKey::_create_verification_op(
...
std::unique_ptr<PK_Ops::Signature> EC_PrivateKey::_create_signature_op(
