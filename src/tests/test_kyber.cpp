...
class KYBER_Tests final : public Test {
   public:
      ...
      std::vector<Test::Result> run() override {
         ...
         results.push_back(run_kyber_test("ML-KEM-512-ipd API", Botan::KyberMode::ML_KEM_512_ipd, 128));
         results.push_back(run_kyber_test("ML-KEM-768-ipd API", Botan::KyberMode::ML_KEM_768_ipd, 192));
         results.push_back(run_kyber_test("ML-KEM-1024-ipd API", Botan::KyberMode::ML_KEM_1024_ipd, 256));
   #endif
