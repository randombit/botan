...
* OID maps
*
* This file was automatically generated by src/scripts/dev_tools/gen_oids.py on 2023-06-19
*
...
std::unordered_map<std::string, std::string> OID_Map::load_oid2str_map() {
   return std::unordered_map<std::string, std::string>{
      ...
      {"1.3.6.1.4.1.2.267.11.4.4", "Dilithium-4x4-AES-r3"},
      {"1.3.6.1.4.1.2.267.11.6.5", "Dilithium-6x5-AES-r3"},
      {"1.3.6.1.4.1.2.267.11.8.7", "Dilithium-8x7-AES-r3"},
      {"1.3.6.1.4.1.2.267.7.4.4", "Dilithium-4x4-r3"},
      {"1.3.6.1.4.1.2.267.7.6.5", "Dilithium-6x5-r3"},
      {"1.3.6.1.4.1.2.267.7.8.7", "Dilithium-8x7-r3"},
      {"1.3.6.1.4.1.22554.5.6.1", "Kyber-512-r3"},
      {"1.3.6.1.4.1.22554.5.6.2", "Kyber-768-r3"},
      {"1.3.6.1.4.1.22554.5.6.3", "Kyber-1024-r3"},
      {"1.3.6.1.4.1.22554.5.6.4", "Kyber-512-90s-r3"},
      {"1.3.6.1.4.1.22554.5.6.5", "Kyber-768-90s-r3"},
      {"1.3.6.1.4.1.22554.5.6.6", "Kyber-1024-90s-r3"},
      ...
      {"1.3.9999.6.4.10", "SphincsPlus-sha2-128s-r3.1"},
      {"1.3.9999.6.4.4", "SphincsPlus-sha2-128f-r3.1"},
      {"1.3.9999.6.5.3", "SphincsPlus-sha2-192f-r3.1"},
      {"1.3.9999.6.5.7", "SphincsPlus-sha2-192s-r3.1"},
      {"1.3.9999.6.6.3", "SphincsPlus-sha2-256f-r3.1"},
      {"1.3.9999.6.6.7", "SphincsPlus-sha2-256s-r3.1"},
...
std::unordered_map<std::string, OID> OID_Map::load_str2oid_map() {
   return std::unordered_map<std::string, OID>{
      ...
      {"Dilithium-4x4-AES-r3", OID({1, 3, 6, 1, 4, 1, 2, 267, 11, 4, 4})},
      {"Dilithium-4x4-r3", OID({1, 3, 6, 1, 4, 1, 2, 267, 7, 4, 4})},
      {"Dilithium-6x5-AES-r3", OID({1, 3, 6, 1, 4, 1, 2, 267, 11, 6, 5})},
      {"Dilithium-6x5-r3", OID({1, 3, 6, 1, 4, 1, 2, 267, 7, 6, 5})},
      {"Dilithium-8x7-AES-r3", OID({1, 3, 6, 1, 4, 1, 2, 267, 11, 8, 7})},
      ...
      {"Kyber-1024-90s-r3", OID({1, 3, 6, 1, 4, 1, 22554, 5, 6, 6})},
      {"Kyber-1024-r3", OID({1, 3, 6, 1, 4, 1, 22554, 5, 6, 3})},
      {"Kyber-512-90s-r3", OID({1, 3, 6, 1, 4, 1, 22554, 5, 6, 4})},
      {"Kyber-512-r3", OID({1, 3, 6, 1, 4, 1, 22554, 5, 6, 1})},
      {"Kyber-768-90s-r3", OID({1, 3, 6, 1, 4, 1, 22554, 5, 6, 5})},
      {"Kyber-768-r3", OID({1, 3, 6, 1, 4, 1, 22554, 5, 6, 2})},
      ...
      {"SphincsPlus-sha2-128f-r3.1", OID({1, 3, 9999, 6, 4, 4})},
      {"SphincsPlus-sha2-128s-r3.1", OID({1, 3, 9999, 6, 4, 10})},
      {"SphincsPlus-sha2-192f-r3.1", OID({1, 3, 9999, 6, 5, 3})},
      {"SphincsPlus-sha2-192s-r3.1", OID({1, 3, 9999, 6, 5, 7})},
      {"SphincsPlus-sha2-256f-r3.1", OID({1, 3, 9999, 6, 6, 3})},
      {"SphincsPlus-sha2-256s-r3.1", OID({1, 3, 9999, 6, 6, 7})},
