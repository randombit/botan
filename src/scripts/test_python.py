...
"""
    ...
    def test_ecdsa(self):
        ...
        compressed_sec1 = BotanPythonTests._ecc_sec1_convert_to_compressed(pub.to_raw())
        pub3 = botan.PublicKey.load_ecdsa_sec1(group, compressed_sec1)
    ...
    def test_sm2(self):
        ...
        # Load public key from SEC.1 encoding
        compressed_sec1 = BotanPythonTests._ecc_sec1_convert_to_compressed(pub.to_raw())
        pub3 = botan.PublicKey.load_sm2_sec1(group, compressed_sec1)
        self._pksign_roundtrips(priv, pub3, hash_fn)
    ...
    def test_ecdh(self):
        ...
        for grp in ['secp256r1', 'secp384r1', 'brainpool256r1']:
            ...
            sec1 = a_priv.get_public_key().to_raw()
            compressed_sec1 = BotanPythonTests._ecc_sec1_convert_to_compressed(sec1)
            new_a_pub1 = botan.PublicKey.load_ecdh_sec1(grp, sec1)
