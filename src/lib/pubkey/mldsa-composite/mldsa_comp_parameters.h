...
class BOTAN_PUBLIC_API(3, 0) MLDSA_Composite_Param {
   public:
      ...
      static inline const char* generic_algo_name = "ML-DSA-Composite";
       ...
       * composite parameter set, e.g. the RSA modulus bit length. Zero if the
       * traditional algorithm has no variable key size.
       */
