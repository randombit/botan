...
BOTAN_FN_ISA_AVX2_BMI2 void SHA_512::compress_digest_x86_avx2(digest_type& digest,
   ...
   while(blocks >= 2) {
      ...
      for(size_t i = 0; i < 8; i++) {
         ...
         auto WK = WS[i] + SIMD_4x64::broadcast_2x64(&K[2 * i]);
