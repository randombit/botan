...
Session::Session(const uint8_t ber[], size_t ber_len)
   ...
   BER_Decoder(ber, ber_len)
      .start_sequence()
        ...
        .decode(m_identifier, ASN1_Type::OCTET_STRING)
        .decode(m_session_ticket, ASN1_Type::OCTET_STRING)
        ...
        .decode(m_master_secret, ASN1_Type::OCTET_STRING)
        .decode(peer_cert_bits, ASN1_Type::OCTET_STRING)
...
secure_vector<uint8_t> Session::DER_encode() const
   ...
   return DER_Encoder()
      .start_sequence()
         ...
         .encode(m_identifier, ASN1_Type::OCTET_STRING)
         .encode(m_session_ticket, ASN1_Type::OCTET_STRING)
         ...
         .encode(m_master_secret, ASN1_Type::OCTET_STRING)
         .encode(peer_cert_bits, ASN1_Type::OCTET_STRING)
         .encode(ASN1_String(m_server_info.hostname(), ASN1_Type::UTF8_STRING))
         .encode(ASN1_String(m_server_info.service(), ASN1_Type::UTF8_STRING))
         .encode(static_cast<size_t>(m_server_info.port()))
         .encode(ASN1_String("", ASN1_Type::UTF8_STRING)) // old srp identifier
